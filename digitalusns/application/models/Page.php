...
class \Page extends \DSF_Db_Table 
{
    ...
    public function pageExists(\DSF\Uri $uri)
    {     
    ...
    private function _flushCache()
    {
    	$cache = \Zend\Registry::get('cache');
       	$cache->clean(\Zend\Cache::CLEANING_MODE_MATCHING_TAG, array('filetree'));
       	$cache->clean(\Zend\Cache::CLEANING_MODE_MATCHING_TAG, array('tree'));
    }
