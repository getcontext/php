...
namespace DSF\Builder\Action;




use Zend\Controller\Front as Front;
use DSF\Builder\BuilderAbstract as BuilderAbstract;
...
class  Page  extends  BuilderAbstract  
{
	...
	public function setLanguage()
	{
	    ...
	    if(!empty($lang)) {
	        ...
	        $this->_page->setLanguage( Language ::getLanguage());
	    }
