...
use DSF\Installer\Environment as Environment;
use DSF\Installer\Database as Database;
use DSF\Installer\Config as Config;
...
class  Installer  {
    ...
    public function setAdminUser($firstName, $lastName, $email, $password)
    {
        ...
        if(!empty($email) &&  Validate ::is($email, 'EmailAddress')) {
