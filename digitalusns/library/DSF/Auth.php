...
use Zend\Auth\Adapter\DbTable as DbTable;
...
class  Auth  
{
	...
	public function __construct($username, $password)
	{
		...
		$this->_dbAdapter = clone (\\Zend\Db_Table::getDefaultAdapter());
		$this->_dbAdapter->setFetchMode( db ::FETCH_ASSOC ); 
		
		$this->_authAdapter = new  DbTable ($this->_dbAdapter, 'users', 'email', 'password');
		...
		$this->_storage = new  SessionNamespace ('adminUser');
	}
	...
	{
		$storage = new  SessionNamespace ('adminUser');
