...
use Zend\Db\Adapter\Oracle\Exception as DbAdapterOracleException;
...
class  Oracle  extends  DbAdapterAbstract 
{
    /**
     ...
     *
     * @return void
     * @throws  DbAdapterOracleException 
     */
    protected function _connect()
    {
        ...
        if (!extension_loaded('oci8')) {
            /**
             * @see  DbAdapterOracleException 
             */
            require_once 'Zend/Db/Adapter/Oracle/Exception.php';
            throw new  DbAdapterOracleException ('The OCI8 extension is required \for this adapter but the extension is not loaded');
        }
        ...
        if (!$this->_connection) {
             ...
             */
            require_once 'Zend/Db/Adapter/Oracle/Exception.php';
            throw new  DbAdapterOracleException (oci_error());
        }
    }
     ...
     * @return  Db _Statement_Oracle
     */
    public function prepare($sql)
    {
        $this->_connect();
        $stmtClass = $this->_defaultStmtClass;
         Loader ::loadClass($stmtClass);
    ...
    protected function _commit()
    {
        if (!oci_commit($this->_connection)) {
             ...
             */
            require_once 'Zend/Db/Adapter/Oracle/Exception.php';
            throw new  DbAdapterOracleException (oci_error($this->_connection));
        }
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            case  Db ::FETCH_BOUND: // bound to PHP variable
                 ...
                 */
                require_once 'Zend/Db/Adapter/Oracle/Exception.php';
                throw new  DbAdapterOracleException ('FETCH_BOUND is not supported yet');
                break;
            default:
                /**
                 * @see  DbAdapterOracleException 
                 */
                require_once 'Zend/Db/Adapter/Oracle/Exception.php';
                throw new  DbAdapterOracleException ("Invalid fetch mode '$mode' specified");
                break;
        }
    }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
             ...
             */
            require_once 'Zend/Db/Adapter/Oracle/Exception.php';
            throw new  DbAdapterOracleException ("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
             ...
             */
            require_once 'Zend/Db/Adapter/Oracle/Exception.php';
            throw new  DbAdapterOracleException ("LIMIT argument offset=$offset is not valid");
        }
    ...
    private function _setExecuteMode($mode)
    {
        switch($mode) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Db/Adapter/Oracle/Exception.php';
                throw new  DbAdapterOracleException ("Invalid execution mode '$mode' specified");
                break;
        }
    }
