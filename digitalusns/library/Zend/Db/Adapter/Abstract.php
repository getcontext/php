...
abstract class  AdapterAbstract 
{
     ...
     * @var string
     */
    protected $_defaultStmtClass = '\Zend\Db\Statement';
     ...
     * If true, most SQL generated by  Db  classes applies
        ...
        if (array_key_exists( Db ::CASE_FOLDING, $options)) {
            ...
            switch ($case) {
                ...
                default:
                    ...
                    throw new  DbAdapterException ('Case must be one \of the following constants: '
                        . '\Zend\Db::CASE_NATURAL,  Db ::CASE_LOWER,  Db ::CASE_UPPER');
            }
        }
    ...
    protected function _checkRequiredOptions(array $config)
    {
        ...
        if (! array_key_exists('password', $config)) {
             ...
             */
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new  DbAdapterException ("Configuration array must have a key \for 'password' \for login credentials");
        }
        ...
        if (! array_key_exists('username', $config)) {
             ...
             */
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new  DbAdapterException ("Configuration array must have a key \for 'username' \for login credentials");
        }
    }
     ...
     *  Profiler , or an instance \of  Config .
     *
     ...
     *
     * @param   Profiler | Config |array|boolean $profiler
     * @return  AdapterAbstract  Provides a fluent interface
     * @throws  DbProfilerException  if the object instance or class specified
    ...
    public function setProfiler($profiler)
    {
        ...
        if ($profilerIsObject = is_object($profiler)) {
            if ($profiler instanceof  Profiler ) {
            ...
            } else if ($profiler instanceof  Config ) {
                ...
                throw new  DbProfilerException ('Profiler argument must be an instance \of either  Db _Profiler'
        ...
        if ($profilerInstance === null) {
            @ Loader ::loadClass($profilerClass);
            $profilerInstance = new $profilerClass();
        }

        if (!$profilerInstance instanceof  Profiler ) {
            require_once 'Zend/Db/Profiler/Exception.php';
            throw new  DbProfilerException ('Class ' . get_class($profilerInstance) . ' does not extend '
                . '\Zend\Db\Profiler');
        }
     ...
     *
     * @return  Db _Abstract Fluent interface
     */
     ...
     * @return  Db _Statement_Interface
     */
     ...
     * @return  Db _Statment|PDOStatement
     */
