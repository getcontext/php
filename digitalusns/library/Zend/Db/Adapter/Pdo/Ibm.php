...
/** @see  DbAdapterPdoAbstract  */
require_once 'Zend/Db/Adapter/Pdo/Abstract.php';

/** @see  Db _Abstract_Pdo_Ibm_Db2 */
require_once 'Zend/Db/Adapter/Pdo/Ibm/Db2.php';

/** @see  Db _Abstract_Pdo_Ibm_Ids */
require_once 'Zend/Db/Adapter/Pdo/Ibm/Ids.php';

/** @see  Db _Statement_Pdo_Ibm */
...
use Zend\Db\Adapter\Pdo\PdoAbstract as DbAdapterPdoAbstract;
use Zend\Db\Adapter\Pdo\Ibm\Db2 as Db2;
use Zend\Db\Adapter\Pdo\Ibm\Ids as Ids;
...
class  Ibm  extends  DbAdapterPdoAbstract 
{
    /**
     * \PDO type.
     *
    ...
    public function _connect()
    {
        ...
        try {
            ...
            if ($error) {
                throw new  DbAdapterException ("PDO_IBM driver extension is downlevel.  Please use driver release version 1.2.1 or later");
            } else {
    ...
    protected function _checkRequiredOptions(array $config)
    {
        ...
        !array_key_exists('port', $config)) {
            /** @see  DbAdapterException  */
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new  DbAdapterException ("Configuration must have a key \for 'port' when 'host' is specified");
        }
    }
