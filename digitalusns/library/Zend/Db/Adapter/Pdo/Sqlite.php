...
class  Sqlite  extends  DbAdapterPdoAbstract 
{
    ...
    protected function _checkRequiredOptions(array $config)
    {
        ...
        if (! array_key_exists('dbname', $config)) {
            ...
            throw new  DbAdapterException ("Configuration array must have a key \for 'dbname' that names the database instance");
        }
    }
    ...
    protected function _connect()
    {
        ...
        if ($retval === false) {
            ...
            /** @see  DbAdapterException  */
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new  DbAdapterException ($error[2]);
        }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
            /** @see  DbAdapterException  */
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new  DbAdapterException ("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
            /** @see  DbAdapterException  */
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new  DbAdapterException ("LIMIT argument offset=$offset is not valid");
        }
