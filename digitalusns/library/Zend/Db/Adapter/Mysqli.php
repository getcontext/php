...
use Zend\Db\Adapter\Mysqli\Exception as DbAdapterMysqliException;
...
class  Mysqli  extends  DbAdapterAbstract 
{
    ...
    public function listTables()
    {
        ...
        if ($queryResult = $this->getConnection()->query($sql)) {
            ...
            /**
             * @see  DbAdapterMysqliException 
             */
            require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
            throw new  DbAdapterMysqliException ($this->getConnection()->error);
        }
        return $result;
    }
     ...
     *
     * @return void
     * @throws  DbAdapterMysqliException 
     */
    protected function _connect()
    {
        ...
        if (!extension_loaded('mysqli')) {
             ...
             */
            require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
            throw new  DbAdapterMysqliException ('The Mysqli extension is required \for this adapter but the extension is not loaded');
        }
        ...
        if ($this->_connection === false || mysqli_connect_errno()) {
             ...
             */
            require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
            throw new  DbAdapterMysqliException (mysqli_connect_error());
        }
    }
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            case  Db ::FETCH_BOUND: // bound to PHP variable
                 ...
                 */
                require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
                throw new  DbAdapterMysqliException ('FETCH_BOUND is not supported yet');
                break;
            default:
                /**
                 * @see  DbAdapterMysqliException 
                 */
                require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
                throw new  DbAdapterMysqliException ("Invalid fetch mode '$mode' specified");
        }
    }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
             ...
             */
            require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
            throw new  DbAdapterMysqliException ("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
             ...
             */
            require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
            throw new  DbAdapterMysqliException ("LIMIT argument offset=$offset is not valid");
        }
