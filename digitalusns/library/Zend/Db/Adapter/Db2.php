...
use Zend\Db\Adapter\Db2\Exception as DbAdapterDb2Exception;
...
class  Db2  extends  DbAdapterAbstract 
{
    /**
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('ibm_db2')) {
            /**
             * @see  DbAdapterDb2Exception 
             */
            require_once 'Zend/Db/Adapter/Db2/Exception.php';
            throw new  DbAdapterDb2Exception ('The IBM DB2 extension is required \for this adapter but the extension is not loaded');
        }
        ...
        if (!$this->_connection) {
             ...
             */
            require_once 'Zend/Db/Adapter/Db2/Exception.php';
            throw new  DbAdapterDb2Exception (db2_conn_errormsg(), db2_conn_error());
        }
    }
    ...
    public function _setExecuteMode($mode)
    {
        switch ($mode) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Db/Adapter/Db2/Exception.php';
                throw new  DbAdapterDb2Exception ("execution mode not supported");
                break;
        }
    }
    ...
    protected function _commit()
    {
        if (!db2_commit($this->_connection)) {
             ...
             */
            require_once 'Zend/Db/Adapter/Db2/Exception.php';
            throw new  DbAdapterDb2Exception (
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            case  Db ::FETCH_BOUND:   // bound to PHP variable
                 ...
                 */
                require_once 'Zend/Db/Adapter/Db2/Exception.php';
                throw new  DbAdapterDb2Exception ('FETCH_BOUND is not supported yet');
                break;
            default:
                /**
                 * @see  DbAdapterDb2Exception 
                 */
                require_once 'Zend/Db/Adapter/Db2/Exception.php';
                throw new  DbAdapterDb2Exception ("Invalid fetch mode '$mode' specified");
                break;
        }
    }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
             ...
             */
            require_once 'Zend/Db/Adapter/Db2/Exception.php';
            throw new  DbAdapterDb2Exception ("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
             ...
             */
            require_once 'Zend/Db/Adapter/Db2/Exception.php';
            throw new  DbAdapterDb2Exception ("LIMIT argument offset=$offset is not valid");
        }
