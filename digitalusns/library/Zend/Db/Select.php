...
use Zend\Db\Select\Exception as DbSelectException;
...
class  Select 
{
     ...
     */
    public function __construct( DbAdapterAbstract  $adapter)
    {
     ...
     *
     * @param  array|string| Expr  $name The table name or an associative array relating table name to
     *                                         correlation name.
     ...
     *
     * The first parameter $select can be a string, an existing  Select 
     * object or an array \of either \of these types.
     *
     * @param  array|string| Select  $select One or more select clauses \for the UNION.
     * @return  Select  This  Select  object.
     */
     ...
     * @param string| Expr  $val A single value to quote into the condition.
     * @return  Select  This  Select  object.
     */
    ...
    protected function _where($condition, $value = null, $type = null, $bool = true)
    {
        if (count($this->_parts[self::UNION])) {
            require_once 'Zend/Db/Select/Exception.php';
            throw new  DbSelectException ("Invalid use \of where clause with " . self::SQL_UNION);
        }
