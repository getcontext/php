...
use Zend\Wildfire\Plugin\FirePhp\TableMessage as TableMessage;
...
class  Firebug  extends  Profiler 
{
    ...
    public function __construct($label = null)
    {
        $this->_label = $label;
        if(!$this->_label) {
            $this->_label = '\Zend\Db\Profiler\Firebug';
        }
    }
    ...
    public function setEnabled($enable)
    {
        ...
        if ($this->getEnabled()) {
            ...
            if (!$this->_message) {
                $this->_message = new  TableMessage ($this->_label);
