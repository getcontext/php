...
use Zend\Db\Profiler\Exception as DbProfilerException;
use Zend\Db\Profiler\Query as Query;
...
class  Profiler 
{
    ...
    /**
     * Starts a query.  Creates a new query profile object ( Query )
    ...
    public function queryEnd($queryId)
    {
        ...
        if (!isset($this->_queryProfiles[$queryId])) {
            /**
             * @see  DbProfilerException 
             */
            require_once 'Zend/Db/Profiler/Exception.php';
            throw new  DbProfilerException ("Profiler has no query with handle '$queryId'.");
        }
        ...
        if ($qp->hasEnded()) {
             ...
             */
            require_once 'Zend/Db/Profiler/Exception.php';
            throw new  DbProfilerException ("Query with profiler handle '$queryId' has already ended.");
        }
     ...
     * by queryStart() and it will return a  Query  object.
     *
     * @param  integer $queryId
     * @throws  DbProfilerException 
     * @return  Query 
    ...
    public function getQueryProfile($queryId)
    {
        if (!array_key_exists($queryId, $this->_queryProfiles)) {
             ...
             */
            require_once 'Zend/Db/Profiler/Exception.php';
            throw new  DbProfilerException ("Query handle '$queryId' not found in profiler log.");
        }
    ...
    /**
     * Get an array \of query profiles ( Query  objects).  If $queryType
    ...
    /**
     * Get the  Query  object \for the last query that was run, regardless if it has
