...
use Zend\Db\Statement\Oracle\Exception as DbStatementOracleException;
...
class  Oracle  extends  Statement 
{
     ...
     * @param string $sql
     * @return void
     * @throws  DbStatementOracleException 
     */
    protected function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            /**
             * @see  DbStatementOracleException 
             */
            require_once 'Zend/Db/Statement/Oracle/Exception.php';
            throw new  DbStatementOracleException (oci_error($connection));
        }
    }
    ...
    protected function _bindParam($parameter, &$variable, $type = null, $length = null, $options = null)
    {
        ...
        if ($retval === false) {
            /**
             * @see  Db _Adapter_Oracle_Exception
             */
            require_once 'Zend/Db/Statement/Oracle/Exception.php';
            throw new  DbStatementOracleException (oci_error($this->_stmt));
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Db/Statement/Oracle/Exception.php';
                throw new  DbStatementOracleException (
                    array(
                        'code'    => 'HYC00',
        ...
        if (! $row && $error = oci_error($this->_stmt)) {
             ...
             */
            require_once 'Zend/Db/Statement/Oracle/Exception.php';
            throw new  DbStatementOracleException ($error);
        }
    ...
    public function fetchAll($style = null, $col = 0)
    {
        ...
        $result = Array();
        if ($flags != OCI_FETCHSTATEMENT_BY_ROW) { /* not  Db ::FETCH_OBJ */
