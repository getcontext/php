...
use Zend\Db\Statement\Db2\Exception as DbStatementDb2Exception;
...
class  Db2  extends  Statement 
{
     ...
     * @param string $sql
     * @return void
     * @throws  DbStatementDb2Exception 
     */
    public function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            /**
             * @see  DbStatementDb2Exception 
             */
            require_once 'Zend/Db/Statement/Db2/Exception.php';
            throw new  DbStatementDb2Exception (
                db2_stmt_errormsg(),
                db2_stmt_error()
            );
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Db/Statement/Db2/Exception.php';
                throw new  DbStatementDb2Exception ("Invalid fetch mode '$style' specified");
                break;
        }
    ...
    public function nextRowset()
    {
         ...
         */
        require_once 'Zend/Db/Statement/Db2/Exception.php';
        throw new  DbStatementDb2Exception (__FUNCTION__ . '() is not implemented');
    }
