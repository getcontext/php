...
use Zend\Db\Statement\Mysqli\Exception as DbStatementMysqliException;
use Zend\Db\Statement as Statement;
use Zend\Db as Db;
...
class  Mysqli  extends  Statement 
{
     ...
     * @param  string $sql
     * @return void
     * @throws  DbStatementMysqliException 
     */
    public function _prepare($sql)
    {
        ...
        if ($this->_stmt === false || $mysqli->errno) {
            /**
             * @see  DbStatementMysqliException 
             */
            require_once 'Zend/Db/Statement/Mysqli/Exception.php';
            throw new  DbStatementMysqliException ("Mysqli prepare error: " . $mysqli->error);
        }
    }
    ...
    public function _execute(array $params = null)
    {
        ...
        if ($retval === false) {
             ...
             */
            require_once 'Zend/Db/Statement/Mysqli/Exception.php';
            throw new  DbStatementMysqliException ("Mysqli statement execute error : " . $this->_stmt->error);
        }
        ...
        if ($this->_meta === null) {
            ...
            if ($this->_stmt->errno) {
                 ...
                 */
                require_once 'Zend/Db/Statement/Mysqli/Exception.php';
                throw new  DbStatementMysqliException ("Mysqli statement metadata error: " . $this->_stmt->error);
            }
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Db/Statement/Mysqli/Exception.php';
                throw new  DbStatementMysqliException ("Invalid fetch mode '$style' specified");
                break;
        }
        return $row;
    }
    ...
    public function nextRowset()
    {
         ...
         */
        require_once 'Zend/Db/Statement/Mysqli/Exception.php';
        throw new  DbStatementMysqliException (__FUNCTION__.'() is not implemented');
    }
