...
use Zend\Db\Statement\StatementInterface as DbStatementInterface;
...
abstract class  Statement  implements  DbStatementInterface 
{
        ...
        foreach ($this->_sqlSplit as $key => $val) {
            if ($val == '?') {
                if ($this->_adapter->supportsParameters('positional') === false) {
                    ...
                    throw new  DbStatementException ("Invalid bind-variable position '$val'");
                }
            } else if ($val[0] == ':') {
    ...
    public function bindParam($parameter, &$variable, $type = null, $length = null, $options = null)
    {
        if (!is_int($parameter) && !is_string($parameter)) {
             ...
             */
            require_once 'Zend/Db/Statement/Exception.php';
            throw new  DbStatementException ('Invalid bind-variable position');
        }
        ...
        if ($position === null) {
             ...
             */
            require_once 'Zend/Db/Statement/Exception.php';
            throw new  DbStatementException ("Invalid bind-variable position '$parameter'");
        }
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Db/Statement/Exception.php';
                throw new  DbStatementException ('invalid fetch mode');
                break;
        }
    }
