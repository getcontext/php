...
class  Claims 
{
    ...
    public function getDefaultNamespace()
    {
        ...
        if(is_null($this->_defaultNamespace)) {
            ...
            if(empty($leader)) {
                throw new  InfoCardException ("Failed to determine default namespace");
            }
    ...
    public function setDefaultNamespace($namespace)
    {
        ...
        throw new  InfoCardException ("At least one claim must exist in specified namespace to make it the default namespace");
    }
    ...
    public function setClaims(Array $claims)
    {
        if(!is_null($this->_claims)) {
            throw new  InfoCardException ("Claim objects are read-only");
        }
    ...
    public function setCode($code)
    {
        ...
        throw new  InfoCardException ("Attempted to set unknown error code");
    }
