...
/**
 *  InfoCardCipherSymmetricAdapterAbstract 
 */
require_once 'Zend/InfoCard/Cipher/Symmetric/Adapter/Abstract.php';

/**
 *  InfoCardCipherSymmetricAes256cbcInterface 
 */
...
use Zend\InfoCard\Cipher\Symmetric\Aes256cbc\Aes256cbcInterface as InfoCardCipherSymmetricAes256cbcInterface;
use Zend\InfoCard\Cipher\Symmetric\Adapter\AdapterAbstract as InfoCardCipherSymmetricAdapterAbstract;
...
class  Aes256cbc 
    extends  InfoCardCipherSymmetricAdapterAbstract 
    implements  InfoCardCipherSymmetricAes256cbcInterface 
{
    /**
    ...
    public function __construct()
    {
        ...
        if(!extension_loaded('mcrypt')) {
            throw new  InfoCardCipherException ("Use \of the AES256CBC Cipher requires the mcrypt extension");
        }
    ...
    public function decrypt($encryptedData, $decryptionKey, $iv_length = null)
    {
        ...
        if(!$decrypted) {
            throw new  InfoCardCipherException ("Failed to decrypt data using AES256CBC Algorithm");
        }
