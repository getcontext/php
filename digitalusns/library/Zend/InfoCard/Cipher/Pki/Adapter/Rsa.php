 ...
 * @subpackage \Zend\InfoCard\Cipher
...
/**
 *  InfoCardCipherPkiAdapterAbstract 
 */
require_once 'Zend/InfoCard/Cipher/Pki/Adapter/Abstract.php';

/**
 *  InfoCardCipherPkiRsaInterface 
 */
...
use Zend\InfoCard\Cipher\Pki\Adapter\AdapterAbstract as InfoCardCipherPkiAdapterAbstract;
use Zend\InfoCard\Cipher\Pki\Rsa\RsaInterface as InfoCardCipherPkiRsaInterface;
...
class  Rsa 
    extends  InfoCardCipherPkiAdapterAbstract 
    implements  InfoCardCipherPkiRsaInterface 
{
     ...
     */
    public function __construct($padding =  InfoCardCipherPkiAdapterAbstract ::NO_PADDING)
    {
        // Can't test this..
        // @codeCoverageIgnoreStart
        if(!extension_loaded('openssl')) {
            throw new  InfoCardCipherException ("Use \of this PKI RSA Adapter requires the openssl extension loaded");
        }
    ...
    public function decrypt($encryptedData, $privateKey, $password = null, $padding = null)
    {
        ...
        if(!$private_key) {
            throw new  InfoCardCipherException ("Failed to load private key");
        }
        ...
        if(!$result) {
            throw new  InfoCardCipherException ("Unable to Decrypt Value using provided private key");
        }
