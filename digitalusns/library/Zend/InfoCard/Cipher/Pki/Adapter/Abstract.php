...
abstract class  AdapterAbstract  implements  InfoCardCipherPkiInterface 
{
    /**
     ...
     * @return \Zend\InfoCard_Pki_Adapter_Abstract
     */
    public function setPadding($padding)
    {
        switch($padding) {
            ...
            case self::NO_PADDING:
                ...
                break;
            default:
                throw new  InfoCardCipherException ("Invalid Padding Type Provided");
        }
