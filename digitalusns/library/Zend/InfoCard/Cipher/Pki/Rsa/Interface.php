...
/**
 * \Zend\InfoCard\Cipher_PKI_Adapter_Abstract
 */
...
interface  RsaInterface 
{
     ...
     */
    public function decrypt($encryptedData, $privateKey, $password = null, $padding =  InfoCardCipherPkiAdapterAbstract ::NO_PADDING);
}
