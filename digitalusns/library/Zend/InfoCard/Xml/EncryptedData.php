...
/**
 * A factory class \for producing  EncryptedData  objects based on
...
final class  EncryptedData 
{
     ...
     * @return  EncryptedData _Abstract
    ...
    static public function getInstance($xmlData)
    {
        ...
        switch($sxe['Type']) {
            ...
            default:
                throw new  InfoCardXmlException ("Unknown EncryptedData type found");
        }
    }
}
