...
class  Saml 
    extends  Element 
    implements  InfoCardXmlAssertionInterface 
{
    ...
    public function getConditions()
    {
        ...
        if(!($conditions instanceof  Element )) {
            throw new  InfoCardXmlException ("Unable to find the saml:Conditions block");
        }
    ...
    public function getSubjectKeyInfo()
    {
        ...
        if($this->getConfirmationMethod() == self::CONFIRMATION_BEARER) {
            throw new  InfoCardXmlException ("Cannot get Subject Key Info when Confirmation Method was Bearer");
        }
    }
