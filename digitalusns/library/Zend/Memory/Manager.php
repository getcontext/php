...
use Zend\Memory\Container\Movable as Movable;
use Zend\Memory\Container\Locked as Locked;
use Zend\Memory\AccessController as AccessController;
...
class  Manager 
{
    ...
    public function __destruct()
    {
        if ($this->_backend !== null) {
            $this->_backend->clean( Cache ::CLEANING_MODE_MATCHING_TAG, $this->_tags);
        }
    }
    ...
    /**
     * Create new  Memory  value container
     *
     * @param string $value
     * @return  Memory _Container_Interface
    ...
    /**
     * Create new  Memory  value container, which has value always
     * locked in memory
     *
     * @param string $value
     * @return  Memory _Container_Interface
    ...
    private function _create($value, $locked)
    {
        ...
        $valueObject = new  Movable ($this, $id, $value);
     ...
     * @internal
     * @param integer $id
     * @return  Memory _Container
     */
    public function unlink( Movable  $container, $id)
    {
     ...
     *
     * @internal
     * @param  Movable  $container
     * @param integer $id
     */
    public function processUpdate( Movable  $container, $id)
    {
        /**
    ...
    private function _swapCheck()
    {
        ...
        throw new  MemoryException ('Memory manager can\'t get enough space.');
    }
     ...
     * @param integer $id
     */
    private function _swap( Movable  $container, $id)
    {
     ...
     * @param integer $id
     */
    public function load( Movable  $container, $id)
    {
