 ...
 *
 * Class also provides  MemoryContainerInterface  interface and works as proxy \for such cases.
 *
 * @category   Zend
 * @package    \Zend\Memory
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
...
class  AccessController  implements  MemoryContainerInterface 
{
    /**
