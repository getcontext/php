...
use Zend\Rest\Client\Exception as RestClientException;
use Zend\Rest\Client\Result as Result;
...
class  Client  extends  ServiceAbstract 
{
     ...
     * Constructor
     *
     * @param string| Http  $uri URI \for the web service
     * @return void
     */
    ...
    /**
     * Call a remote REST web service URI and return the \Zend\Http\Response object
     *
    ...
    final private function _prepareRest($path)
    {
        ...
        if (!$this->_uri instanceof  Http ) {
            ...
            throw new  RestClientException ('URI object must be set before performing call');
        }
         ...
         * because the \Zend\Http\Client instance is shared among all  ServiceAbstract  subclasses.
         */
     ...
     * @return  Result | Client  \Zend\Rest\Client if using
     * a remote method,  Result  if using an HTTP request method
     */
    public function __call($method, $args)
    {
        ...
        if (in_array(strtolower($method), $methods)) {
            ...
            // More than one arg means it's definitely a \Zend\Rest\Server
            if (sizeof($args) == 1) {
