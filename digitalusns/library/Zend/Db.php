...
class  Db 
{
    ...
    /**
     * Use the PROFILER constant in the config \of a  Db _Adapter.
     */
    const PROFILER = 'profiler';

    /**
     * Use the CASE_FOLDING constant in the config \of a  Db _Adapter.
     */
    const CASE_FOLDING = 'caseFolding';

    /**
     * Use the AUTO_QUOTE_IDENTIFIERS constant in the config \of a  Db _Adapter.
     */
    ...
    /**
     * Factory \for  DbAdapterAbstract  classes.
     *
     * First argument may be a string containing the base \of the adapter class
     * name, e.g. 'Mysqli' corresponds to class  Db _Adapter_Mysqli.  This
     * is case-insensitive.
     *
    ...
    public static function factory($adapter, $config = array())
    {
        ...
        $adapterName = $adapterNamespace . '\\' . str_replace(' ', '\\', ucwords(str_replace('_', ' ', strtolower($adapter))));
        /*
         * Load the adapter class.  This throws an exception
         * if the specified class cannot be loaded.
         */
        @ Loader ::loadClass($adapterName);
         ...
         */
        if (! $dbAdapter instanceof  DbAdapterAbstract ) {
            /**
             * @see  DbException 
             */
            require_once 'Zend/Db/Exception.php';
            throw new  DbException ("Adapter class '$adapterName' does not extend  Db _Adapter_Abstract");
        }
