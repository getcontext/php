 ...
 *
 * @uses  ControllerRequestAbstract 
 * @package Zend_Controller
 * @subpackage Request
 */


use Zend\Controller\Request\Exception as ControllerRequestException;
...
class  Http  extends  ControllerRequestAbstract 
{
    /**
     * Scheme \for http
     *
     ...
     * @return void
     * @throws  ControllerRequestException  when invalid URI passed
     */
    public function __construct($uri = null)
    {
        if (null !== $uri) {
            ...
            if ($uri->valid()) {
                ...
                require_once 'Zend/Controller/Request/Exception.php';
                throw new  ControllerRequestException ('Invalid URI provided to constructor');
            }
        } else {
            $this->setRequestUri();
        }
     ...
     * @param mixed $value
     * @return void
     * @throws  ControllerRequestException 
     */
    public function __set($key, $value)
    {
        require_once 'Zend/Controller/Request/Exception.php';
        throw new  ControllerRequestException ('Setting values in superglobals not allowed; please use setParam()');
    }
    ...
    public function getHeader($header)
    {
        if (empty($header)) {
            require_once 'Zend/Controller/Request/Exception.php';
            throw new  ControllerRequestException ('An HTTP header name is required');
        }
