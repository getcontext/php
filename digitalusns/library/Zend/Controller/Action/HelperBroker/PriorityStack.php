...
class  PriorityStack  implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     */
    public function push( ControllerActionHelperAbstract  $helper)
    {
    ...
    public function offsetGet($priorityOrHelperName)
    {
        if (!$this->offsetExists($priorityOrHelperName)) {
            ...
            throw new  ControllerActionException ('A helper with priority ' . $priority . ' does not exist.');
        }
    ...
    public function offsetSet($priority, $helper)
    {
        ...
        if (!$helper instanceof  ControllerActionHelperAbstract ) {
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException ('$helper must extend  ControllerActionHelperAbstract .');
        }
    ...
    public function offsetUnset($priorityOrHelperName)
    {
        if (!$this->offsetExists($priorityOrHelperName)) {
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException ('A helper with priority or name ' . $priorityOrHelperName . ' does not exist.');
        }
