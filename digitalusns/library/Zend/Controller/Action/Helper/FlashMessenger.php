...
class  FlashMessenger  extends  ControllerActionHelperAbstract  implements \IteratorAggregate, \Countable
{
    /**
    ...
    /**
     * $_session - \Zend\Session storage object
     *
     * @var \Zend\Session
     */
    ...
    {
        if (!self::$_session instanceof  SessionNamespace ) {
            self::$_session = new  SessionNamespace ($this->getName());
