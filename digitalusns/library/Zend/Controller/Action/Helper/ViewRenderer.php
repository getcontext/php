 ...
 * <code>
 * // In your bootstrap:
 *  HelperBroker ::addHelper(new \Zend_Controller_Action_Helper_ViewRenderer());
 *
...
class \Zend_Controller_Action_Helper_ViewRenderer extends  ControllerActionHelperAbstract 
{
    /**
     * @var  ViewInterface 
     */
     ...
     * @return void
     */
    public function __construct( ViewInterface  $view = null, array $options = array())
    {
        if (null !== $view) {
            $this->setView($view);
        }
    ...
    public function getModuleDirectory()
    {
        ...
        if ((null === $moduleDir) || is_array($moduleDir)) {
            ...
            throw new  ControllerActionException ('ViewRenderer cannot locate module directory');
        }
        ...
        if (null === $this->_inflector) {
            ...
            $this->_inflector->setStaticRuleReference('moduleDir', $this->_moduleDir) // moduleDir must be specified before the less specific 'module'
                 ->addRules(array(
                     ...
                     ':controller' => array('Word_CamelCaseToDash', new  UnderscoreToSeparator ('/'), 'StringToLower'),
                     ':action'     => array('Word_CamelCaseToDash', new  PregReplace ('#[^a-z0-9' . preg_quote('/', '#') . ']+#i', '-'), 'StringToLower'),
                 ))
     ...
     * @return \Zend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
    public function setInflector( Inflector  $inflector, $reference = false)
    {
    ...
    public function initView($path = null, $prefix = null, array $options = array())
    {
        ...
        if (empty($path)) {
            ...
            if (empty($path)) {
                 ...
                 */
                require_once 'Zend/Controller/Action/Exception.php';
                throw new  ControllerActionException ('ViewRenderer initialization failed: retrieved view base path is empty');
            }
        }
