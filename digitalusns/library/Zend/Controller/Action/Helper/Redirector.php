...
class  Redirector  extends  ControllerActionHelperAbstract 
{
    /**
     ...
     *
     * @param  int $code
     * @throws  ControllerActionException  on invalid HTTP status code
     * @return true
     */
    protected function _checkCode($code)
    {
        ...
        if ((300 > $code) || (307 < $code)) {
            /**
             * @see \Zend\Controller\Exception
             */
            require_once 'Zend/Controller/Exception.php';
            throw new  ControllerActionException ('Invalid redirect HTTP status code (' . $code  . ')');
        }
    ...
    public function redirectAndExit()
    {
        ...
        if (class_exists('\Zend\Session', false) &&  Session ::isStarted()) {
             Session ::writeClose();
     ...
     * @param  array $args 
     * @return mixed
     * @throws  ControllerActionException  \for invalid methods
     */
    public function __call($method, $args)
    {
        ...
        require_once 'Zend/Controller/Action/Exception.php';
        throw new  ControllerActionException (sprintf('Invalid method "%s" called on redirector', $method));
    }
}
