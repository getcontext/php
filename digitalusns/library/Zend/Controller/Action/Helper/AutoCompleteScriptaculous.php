...
/**
 * @see  ControllerActionHelperAutoCompleteAbstract 
 */
 ...
 *
 * @uses        ControllerActionHelperAutoCompleteAbstract 
 * @category   Zend
 * @package    Zend_Controller
 * @subpackage Zend_Controller_Action_Helper
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
...
use Zend\Controller\Action\Helper\AutoComplete\AutoCompleteAbstract as ControllerActionHelperAutoCompleteAbstract;
use Zend\Controller\Action\Exception as ControllerActionException;




class  AutoCompleteScriptaculous  extends  ControllerActionHelperAutoCompleteAbstract 
{
    /**
