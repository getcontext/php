...
class  ContextSwitch  extends  ControllerActionHelperAbstract 
{
    /**
     ...
     * 
     * @param  array $options 
     * @return  ContextSwitch  Provides a fluent interface
     */
    ...
    public function initContext($format = null)
    {
        ...
        if (null !== ($callback = $this->getCallback($context, self::TRIGGER_INIT))) {
            if (is_string($callback) && method_exists($this, $callback)) {
                ...
                throw new  ControllerActionException (sprintf('Invalid context callback registered \for context "%s"', $context));
            }
        }
            ...
            if (is_string($suffixInfo)) {
                ...
                switch (true) {
                    case (($count < 2) && (null === $context)):
                         ...
                         */
                        require_once 'Zend/Controller/Action/Exception.php';
                        throw new  ControllerActionException ('Invalid suffix information provided in config');
                    case ($count < 2):
    ...
    public function setSuffix($context, $suffix, $prependViewRendererSuffix = true)
    {
        if (!isset($this->_contexts[$context])) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Cannot set suffix; invalid context type "%s"', $context));
        }
    ...
    public function getSuffix($type)
    {
        if (!isset($this->_contexts[$type])) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Cannot retrieve suffix; invalid context type "%s"', $type));
        }
     ...
     * @throws  ControllerActionException  if context does not exist and throwException is true
     * @return bool
     */
    public function hasContext($context, $throwException = false)
    {
        ...
        if ($throwException) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Context "%s" does not exist', $context));
        }
    ...
    public function addHeader($context, $header, $content)
    {
        ...
        if (isset($this->_contexts[$context]['headers'][$header])) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Cannot add "%s" header to context "%s": already exists', $header, $context));
        }
    ...
    protected function _validateTrigger($trigger)
    {
        ...
        if (!in_array($trigger, array(self::TRIGGER_INIT, self::TRIGGER_POST))) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Invalid trigger "%s"', $trigger));
        }
    ...
    public function setCallback($context, $trigger, $callback)
    {
        ...
        if (!is_string($callback)) {
            if (!is_array($callback) || (2 != count($callback))) {
                 ...
                 */
                require_once 'Zend/Controller/Action/Exception.php';
                throw new  ControllerActionException ('Invalid callback specified');
            }
        }
    ...
    public function setDefaultContext($type)
    {
        if (!isset($this->_contexts[$type])) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Cannot set default context; invalid context type "%s"', $type));
        }
    ...
    public function addContext($context, array $spec)
    {
        if ($this->hasContext($context)) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf('Cannot add context "%s"; already exists', $context));
        }
        $context = (string) $context;
        ...
        if (null !== $context) {
            if (null !== ($callback = $this->getCallback($context, self::TRIGGER_POST))) {
                if (is_string($callback) && method_exists($this, $callback)) {
                     ...
                     */
                    require_once 'Zend/Controller/Action/Exception.php';
                    throw new  ControllerActionException (sprintf('Invalid postDispatch context callback registered \for context "%s"', $context));
                }
            }
        }
    }
     ...
     * @return  ContextSwitch |void Provides a fluent interface
     */
    ...
    public function hasActionContext($action, $context)
    {
        ...
        if (!is_array($allContexts)) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException ("Invalid contexts found \for controller");
        }
        ...
        if (!is_array($contexts)) {
             ...
             */
            require_once 'Zend/Controller/Action/Exception.php';
            throw new  ControllerActionException (sprintf("Invalid contexts found \for action '%s'", $action));
        }
