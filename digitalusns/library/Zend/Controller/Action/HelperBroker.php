...
use Zend\Controller\Action\HelperBroker\PriorityStack as PriorityStack;
...
class  HelperBroker 
{
     ...
     *
     * @param  ControllerActionHelperAbstract  $helper
     * @return void
     */
    static public function addHelper( ControllerActionHelperAbstract  $helper)
    {
     ...
     *
     * @param  string $name
     * @return  ControllerActionHelperAbstract 
     */
    ...
    public static function getExistingHelper($name)
    {
        ...
        throw new  ControllerActionException ('Action helper "' . $name . '" has not been registered with the helper broker');
    }
    ...
    protected static function _loadHelper($name)
    {
        ...
        foreach ($paths as $info) {
            ...
            if (class_exists($class, false)) {
                ...
                if (!$helper instanceof  ControllerActionHelperAbstract ) {
                    throw new  ControllerActionException ('Helper name ' . $name . ' -> class ' . $class . ' is not \of type \Zend\Controller\Action\Helper\HelperAbstract');
                }
        ...
        throw new  ControllerActionException ('Action Helper by name ' . $name . ' not found.');
    }
     ...
     * @param  array $args
     * @return mixed
     * @throws  ControllerActionException  if helper does not have a direct() method
     */
    public function __call($method, $args)
    {
        ...
        throw new  ControllerActionException ('Helper "' . $method . '" does not support overloading via direct()');
    }
