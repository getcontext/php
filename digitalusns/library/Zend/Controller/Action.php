...
use Zend\Controller\Action\Helper\Redirector as ControllerActionHelperRedirector;
...
abstract class \Zend_Controller_Action
{
    ...
    /**
     *  ControllerRequestAbstract  object wrapping the request environment
     * @var  ControllerRequestAbstract 
     */
    protected $_request = null;

    /**
     *  ControllerResponseAbstract  object wrapping the response
     ...
     * @return void
     */
    public function __construct( ControllerRequestAbstract  $request,  ControllerResponseAbstract  $response, array $invokeArgs = array())
    {
     ...
     *
     * If {@link $view} is not otherwise set, instantiates a new  ZendView 
     ...
     * @throws  ControllerException  if base view directory does not exist
     */
    public function initView()
    {
        ...
        $this->view = new  ZendView (array('basePath' => $baseDir));
     ...
     *
     * @see  ControllerResponseAbstract ::appendBody()
     ...
     * @param  bool $noController  Defaults to false; i.e. use controller name as subdir in which to search \for view script
     * @return string
     * @throws  ControllerException  with bad $action
     */
    public function getViewScript($action = null, $noController = null)
    {
        ...
        if (null === $action) {
            ...
            throw new  ControllerException ('Invalid action specifier \for view render');
        }
     ...
     *
     * @return  ControllerRequestAbstract 
     */
     ...
     *
     * @return  ControllerResponseAbstract 
     */
     ...
     * @return \Zend\Controller\Action\Helper\HelperAbstract
     */
    ...
    public function getFrontController()
    {
        ...
        throw new  ControllerException ('Front controller class has not been loaded');
    }
    ...
    public function __call($methodName, $args)
    {
        if ('Action' == substr($methodName, -6)) {
            ...
            throw new  ControllerActionException (sprintf('Action "%s" does not exist and was not trapped in __call()', $action), 404);
        }

        require_once 'Zend/Controller/Action/Exception.php';
        throw new  ControllerActionException (sprintf('Method "%s" does not exist and was not trapped in __call()', $methodName), 500);
    }
     ...
     * request.
     *
     * Returns a  ControllerResponseAbstract  object, instantiating one
     ...
     *
     * @param null| ControllerRequestAbstract  $request Optional request
     * object to use
     * @param null| ControllerResponseAbstract  $response Optional response
     * object to use
     * @return  ControllerResponseAbstract 
     */
    public function run( ControllerRequestAbstract  $request = null,  ControllerResponseAbstract  $response = null)
    {
        if (null !== $request) {
            $this->setRequest($request);
        } else {
     ...
     *
     * Proxies to {@link  ControllerActionHelperRedirector ::gotoUrl()}.
     *
     * @param string $url
