...
use Zend\Controller\Dispatcher\DispatcherInterface as ControllerDispatcherInterface;
use Zend\Controller\Action\HelperBroker as HelperBroker;
use Zend\Controller\Dispatcher\Standard as Standard;
use Zend\Controller\Plugin\ErrorHandler as ErrorHandler;
...
use Zend\Controller\Router\RouterInterface as ControllerRouterInterface;
use Zend\Controller\Router\Rewrite as Rewrite;
use Zend\Controller\Plugin\Broker as Broker;
use Zend\Controller\Response\Http as ControllerResponseHttp;
use Zend\Controller\Request\Http as ControllerRequestHttp;
...
class  Front 
{
    ...
    /**
     * Instance \of  ControllerDispatcherInterface 
     * @var  ControllerDispatcherInterface 
     */
    ...
    /**
     * Instance \of  ControllerRequestAbstract 
     * @var  ControllerRequestAbstract 
     */
    protected $_request = null;

    /**
     * Instance \of  ControllerResponseAbstract 
    ...
    /**
     * Instance \of  ControllerRouterInterface 
     * @var  ControllerRouterInterface 
     */
     ...
     * @return void
     * @throws  ControllerException  if called from an object instance
     */
     ...
     * @return  Front 
     * @throws  ControllerException  if directory not found or readable
     */
    ...
    public function addModuleDirectory($path)
    {
        try{
            ...
            throw new  ControllerException ("Directory $path not readable");
        }
        foreach ($dir as $file) {
     ...
     *
     * @param string| ControllerRequestAbstract  $request
     * @throws  ControllerException  if invalid request class
     * @return  Front 
     */
    public function setRequest($request)
    {
        ...
        if (!$request instanceof  ControllerRequestAbstract ) {
            throw new  ControllerException ('Invalid request class');
        }
     ...
     *
     * @return null| ControllerRequestAbstract 
     */
     ...
     *
     * @param string| ControllerRouterInterface  $router
     * @throws  ControllerException  if invalid router class
     * @return  Front 
     */
    public function setRouter($router)
    {
        ...
        if (!$router instanceof  ControllerRouterInterface ) {
            throw new  ControllerException ('Invalid router class');
        }
     ...
     *
     * Instantiates a  Rewrite  object if no router currently set.
     *
     * @return  ControllerRouterInterface 
     */
    public function getRouter()
    {
        if (null == $this->_router) {
            require_once 'Zend/Controller/Router/Rewrite.php';
            $this->setRouter(new  Rewrite ());
        }
     ...
     * @param string $base
     * @return  Front 
     * @throws  ControllerException  \for non-string $base
     */
    public function setBaseUrl($base = null)
    {
        if (!is_string($base) && (null !== $base)) {
            throw new  ControllerException ('Rewrite base must be a string');
        }
     ...
     *
     * @param  ControllerDispatcherInterface  $dispatcher
     * @return  Front 
     */
     ...
     *
     * @return  ControllerDispatcherInterface 
     */
    public function getDispatcher()
    {
         ...
         */
        if (!$this->_dispatcher instanceof  ControllerDispatcherInterface ) {
     ...
     *
     * @param string| ControllerResponseAbstract  $response
     * @throws  ControllerException  if invalid response class
     * @return  Front 
     */
    public function setResponse($response)
    {
        ...
        if (!$response instanceof  ControllerResponseAbstract ) {
            throw new  ControllerException ('Invalid response class');
        }
     ...
     *
     * @return null| ControllerResponseAbstract 
     */
     ...
     * @return boolean| Front  Used as a setter, returns object; as a getter, returns boolean
     */
     ...
     *
     * @param  ControllerRequestAbstract |null $request
     * @param  ControllerResponseAbstract |null $response
     * @return void| ControllerResponseAbstract  Returns response object if returnResponse() is true
     */
    public function dispatch( ControllerRequestAbstract  $request = null,  ControllerResponseAbstract  $response = null)
    {
        if (!$this->getParam('noErrorHandler') && !$this->_plugins->hasPlugin('\Zend\Controller\Plugin\ErrorHandler')) {
            // Register with stack index \of 100
            require_once 'Zend/Controller/Plugin/ErrorHandler.php';
            $this->_plugins->registerPlugin(new  ErrorHandler (), 100);
        }

        if (!$this->getParam('noViewRenderer') && ! HelperBroker ::hasHelper('viewRenderer')) {
            require_once 'Zend/Controller/Action/Helper/ViewRenderer.php';
             HelperBroker ::getStack()->offsetSet(-80, new \Zend_Controller_Action_Helper_ViewRenderer());
        }
        ...
        if (null !== $request) {
            ...
            $request = new  ControllerRequestHttp ();
            $this->setRequest($request);
        }
        ...
        if (null !== $response) {
            ...
            $response = new  ControllerResponseHttp ();
            $this->setResponse($response);
        }
