...
class  Chain  extends  ControllerRouterRouteAbstract 
{
    ...
    public function chain( ControllerRouterRouteInterface  $route, $separator = '/') {
     ...
     *
     * @param  Http  $request Request to get the path info from
