...
class  Hostname  extends  ControllerRouterRouteAbstract 
{
     ...
     *
     * @param  Http  $request Request to get the host from
        ...
        foreach ($this->_parts as $key => $part) {
            ...
            if (isset($name)) {
                if (isset($data[$name]) && !$useDefault) {
                    ...
                    throw new  ControllerRouterException ($name . ' is not specified');
                }
            } else {
                $host[$key] = $part;
            }
