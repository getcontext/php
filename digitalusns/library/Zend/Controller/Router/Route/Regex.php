...
class  Regex  extends  ControllerRouterRouteAbstract 
{
    ...
    public static function getInstance( Config  $config)
    {
        ...
        $map = ($config->map instanceof  Config ) ? $config->map->toArray() : array();
    ...
    public function assemble($data = array(), $reset = false, $encode = false)
    {
        if ($this->_reverse === null) {
            ...
            throw new  ControllerRouterException ('Cannot assemble. Reversed route is not specified.');
        }
        ...
        if ($return === false) {
            require_once 'Zend/Controller/Router/Exception.php';
            throw new  ControllerRouterException ('Cannot assemble. Too few arguments?');
        }
