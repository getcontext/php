...
use Zend\Controller\Response\Exception as ControllerResponseException;
...
abstract class  ResponseAbstract 
{
    ...
    public function setHttpResponseCode($code)
    {
        if (!is_int($code) || (100 > $code) || (599 < $code)) {
            ...
            throw new  ControllerResponseException ('Invalid HTTP response code');
        }
    ...
    public function canSendHeaders($throw = false)
    {
        ...
        if ($ok && $throw && $this->headersSentThrowsException) {
            require_once 'Zend/Controller/Response/Exception.php';
            throw new  ControllerResponseException ('Cannot send headers; headers already sent in ' . $file . ', line ' . $line);
        }
    ...
    public function append($name, $content)
    {
        if (!is_string($name)) {
            require_once 'Zend/Controller/Response/Exception.php';
            throw new  ControllerResponseException ('Invalid body segment key ("' . gettype($name) . '")');
        }
    ...
    public function insert($name, $content, $parent = null, $before = false)
    {
        ...
        if ((null !== $parent) && !is_string($parent)) {
            require_once 'Zend/Controller/Response/Exception.php';
            throw new  ControllerResponseException ('Invalid body segment parent key ("' . gettype($parent) . '")');
        }
