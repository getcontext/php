...
abstract class  DispatcherAbstract  implements  ControllerDispatcherInterface 
{
    /**
     * Default action
     * @var string
     ...
     * @var  ControllerResponseAbstract |null
     */
     ...
     * controller name, such as one stored inside a \Zend\Controller\Request\RequestAbstract
     ...
     * action name, such as one that would be stored inside a \Zend\Controller\Request\RequestAbstract
     ...
     * @return array
     * @throws  ControllerDispatcherException  with invalid delimiters
     */
    public function _verifyDelimiter($spec)
    {
        if (is_string($spec)) {
            ...
            if (!$allStrings) {
                ...
                throw new  ControllerDispatcherException ('Word delimiter array must contain only strings');
            }
        ...
        require_once 'Zend/Controller/Dispatcher/Exception.php';
        throw new  ControllerDispatcherException ('Invalid word delimiter');
    }
    ...
    public function setPathDelimiter($spec)
    {
        if (!is_string($spec)) {
            require_once 'Zend/Controller/Dispatcher/Exception.php';
            throw new  ControllerDispatcherException ('Invalid path delimiter');
        }
     ...
     *
     * @param  Front  $controller
     * @return  DispatcherAbstract 
     */
    public function setFrontController( Front  $controller)
    {
     ...
     * @return  DispatcherAbstract 
     */
    public function setResponse( ControllerResponseAbstract  $response = null)
    {
     ...
     *
     * @return  ControllerResponseAbstract |null
     */
