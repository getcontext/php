...
use Zend\File\Transfer\Adapter as Adapter;
...
class  Transfer 
{
    ...
    public function __construct($protocol = null)
    {
        ...
        throw new  FileTransferException ('Implementation in progress');
        ...
        if (!$this->_adapter instanceof  Adapter ) {
            require_once 'Zend/File/Transfer/Exception.php';
            throw new  FileTransferException ("Adapter " . $adapter . " does not extend  Transfer _Adapter'");
        }
