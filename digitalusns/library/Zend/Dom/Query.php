...
use Zend\Dom\Query\Css2Xpath as Css2Xpath;
...
class  Query 
{
    ...
    public function queryXpath($xpathQuery, $query = null)
    {
        if (null === ($document = $this->getDocument())) {
            ...
            throw new  DomException ('Cannot query; no document registered');
        }
        ...
        if (!$success) {
            require_once 'Zend/Dom/Exception.php';
            throw new  DomException (sprintf('Error parsing document (type == %s)', $type));
        }
