...
abstract class  Adapter  {
     ...
     * @param  string| Locale  $locale  (optional) Locale/Language to set, identical with Locale
     *                                     identifiers see  Locale  \for more information
    ...
    public function __construct($data, $locale = null, array $options = array())
    {
        if (isset(self::$_cache)) {
            $id = '\Zend\Translate_' . $this->toString();
     ...
     * @param  string| Locale  $locale  (optional) Locale/Language to add data \for, identical
     *                                        with locale identifier, see  Locale  \for more information
     * @param  array              $options (optional) Option \for this Adapter
     * @throws  TranslateException 
     * @return  Adapter  Provides a fluid interface
     */
    public function addTranslation($data, $locale = null, array $options = array())
    {
        ...
        if (is_string($data) and is_dir($data)) {
            ...
            foreach (new \RecursiveIteratorIterator(
                ...
                if ($info->isDir()) {
                    // pathname as locale
                    if (($this->_options['scan'] === self::LOCALE_DIRECTORY) and ( Locale ::isLocale($file))) {
                    ...
                    if ($this->_options['scan'] === self::LOCALE_FILENAME) {
                        ...
                        if ( Locale ::isLocale((string) $filename)) {
    ...
    public function setLocale($locale)
    {
        if ($locale instanceof  Locale ) {
            $locale = $locale->toString();
        } else if (!$locale =  Locale ::isLocale($locale)) {
            /**
             * @see  TranslateException 
             */
            require_once 'Zend/Translate/Exception.php';
            throw new  TranslateException ("The given Language ({$locale}) does not exist");
        }
        ...
        if (empty($this->_translate[$locale]) === true) {
            ...
            if (isset($this->_translate[$temp[0]]) === false) {
                 ...
                 */
                require_once 'Zend/Translate/Exception.php';
                throw new  TranslateException ("Language ({$locale}) has to be added before it can be used.");
            }
            $locale = $temp[0];
        }
     ...
     *
     * @param  string| Locale  $locale (optional) Language to return the message ids from
     * @return array
     */
     ...
     *
     * @param  string| Locale  $locale (optional) Language to return the messages from
     * @return array
     */
     ...
     *
     * @see     Locale 
     * @param  string| Locale  $locale Language to search \for, identical with locale identifier,
     ...
     * @see     Locale 
     * @param  array|string       $data    Translation data
     * @param  string| Locale  $locale  Locale/Language to add data \for, identical with locale identifier,
     *                                     @see  Locale  \for more information
     * @param  array              $options (optional) Option \for this Adapter
     * @throws  TranslateException 
     * @return  Adapter  Provides a fluid interface
    ...
    {
        if (!$locale =  Locale ::isLocale($locale)) {
            /**
             * @see  TranslateException 
             */
            require_once 'Zend/Translate/Exception.php';
     ...
     * @param  string| Locale  $locale    (optional) Locale/Language to use, identical with
     *                                       locale identifier, @see  Locale  \for more information
     * @return string
     */
     ...
     *
     * @param  string             $messageId Translation string
     * @param  string| Locale  $locale    (optional) Locale/Language to use, identical with locale
     *                                       identifier, @see  Locale  \for more information
     * @return string
     */
     ...
     * @param  string| Locale  $locale    (optional) Locale/Language to use, identical with locale identifier,
     *                                       see  Locale  \for more information
     * @return boolean
     */
    ...
    /**
     * Sets a cache \for all  Adapter s
     *
