...
class  Image  extends  Word 
{
    ...
    { 
        if (!extension_loaded("gd")) {
            ...
            throw new  FormException ("Image CAPTCHA requires GD extension");
        }

        if (!function_exists("imagepng")) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException ("Image CAPTCHA requires PNG support");
        }

        if (!function_exists("imageftbbox")) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException ("Image CAPTCHA requires FT fonts support");
        }
        ...
        if (empty($font)) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException ("Image CAPTCHA requires font");
        }
