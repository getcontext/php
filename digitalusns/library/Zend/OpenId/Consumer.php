...
use Zend\OpenId\Consumer\Storage\File as File;
use Zend\OpenId\Consumer\Storage as Storage;
...
class  Consumer 
{
    ...
    /**
     * Constructs a  Consumer  object with given $storage.
     * Enables or disables future association with server based on
     * Diffie-Hellman key agreement.
     *
     * @param  Storage  $storage implementation \of custom
     *  storage object
    ...
    public function verify($params, &$identity = "", $extensions = null)
    {
        ...
        if ($version < 2.0 && !isset($params["openid_claimed_id"])) {
            if ($this->_session === null) {
                ...
                $this->_session = new  SessionNamespace ("zend_openid");
            }
        ...
        if ($this->_storage->getAssociationByHandle(
            ...
            if (base64_decode($params['openid_sig']) ==
                ...
                if (! Extension ::forAll($extensions, 'parseResponse', $params)) {
    ...
    protected function _checkId($immediate, $id, $returnTo=null, $root=null,
        $extensions=null,  ControllerResponseAbstract  $response = null)
    {
        $this->_setError('');
        ...
        if (! Extension ::forAll($extensions, 'prepareRequest', $params)) {
     ...
     *
     * @param  Client  $client HTTP client object to be used
     */
     ...
     *
     * @param  SessionNamespace  $session HTTP client object to be used
     */
