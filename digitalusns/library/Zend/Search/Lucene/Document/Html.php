...
class  Html  extends  Document 
{
    ...
    private function __construct($data, $isFile, $storeContent)
    {
        ...
        $this->addField( Field ::Text('title', $docTitle, $this->_doc->actualEncoding));
        ...
        if ($storeContent) {
            $this->addField( Field ::Text('body', $docBody, $this->_doc->actualEncoding));
        } else {
            $this->addField( Field ::UnStored('body', $docBody, $this->_doc->actualEncoding));
        }
    ...
    {
        return new  Html ($data, false, $storeContent);
    }
    ...
    {
        return new  Html ($file, true, $storeContent);
    }
