...
use Zend\Search\Lucene\Index\SegmentWriter\DocumentWriter as DocumentWriter;
use Zend\Search\Lucene\Index\SegmentMerger as SegmentMerger;
use Zend\Search\Lucene\Storage\Directory as Directory;
use Zend\Search\Lucene\Index\SegmentInfo as SegmentInfo;
use Zend\Search\Lucene\Storage\File as File;
...
class  Writer 
{
     ...
     * @todo Implement  Directory RAM and  File RAM to use it \for
    ...
    public function addDocument( Document  $document)
    {
        if ($this->_currentSegment === null) {
            $this->_currentSegment =
                new  DocumentWriter ($this->_directory, $this->_newSegmentName());
        }
            ...
            \for ($count = 0; $count < $segmentsCount; $count++) {
                ...
                if (!in_array($segName, $this->_segmentsToDelete)) {
                    ...
                    if ($this->_targetFormatVersion ==  Lucene ::FORMAT_2_3) {
                        ...
                        throw new  SearchLuceneException ('Index conversion to lower format version is not supported.');
                    }
