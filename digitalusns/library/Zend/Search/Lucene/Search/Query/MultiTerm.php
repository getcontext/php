...
/**  SearchLuceneSearchWeightMultiTerm  */
...
use Zend\Search\Lucene\Search\Weight\MultiTerm as SearchLuceneSearchWeightMultiTerm;
...
class  MultiTerm  extends  Query 
{
    ...
    /**
     * Terms to find.
     * Array \of  SearchLuceneIndexTerm 
     *
     * @var array
     */
    ...
    /**
     * Terms weights
     * array \of \Zend\Search\Lucene\Search\Weight
     *
     * @var array
     */
     ...
     *
     * @param array $terms    Array \of  SearchLuceneIndexTerm  objects
    ...
    /**
     * Add a $term ( SearchLuceneIndexTerm ) to this query.
     *
     ...
     * @return void
     */
    public function addTerm( SearchLuceneIndexTerm  $term, $sign = null) {
    ...
    public function rewrite( SearchLuceneInterface  $index)
    {
        ...
        if ($allQualified) {
            ...
            foreach ($this->_terms as $termId => $term) {
                $subquery = new  SearchLuceneSearchQueryTerm ($term);
    ...
    public function optimize( SearchLuceneInterface  $index)
    {
        ...
        if (count($terms) == 1) {
            ...
            $optimizedQuery = new  SearchLuceneSearchQueryTerm (reset($terms));
    ...
    {
        $this->_weight = new  SearchLuceneSearchWeightMultiTerm ($this, $reader);
        return $this->_weight;
    }
     ...
     * @param  SearchLuceneInterface  $reader
     */
    private function _calculateConjunctionResult( SearchLuceneInterface  $reader)
    {
     ...
     * @param  SearchLuceneInterface  $reader
     */
    private function _calculateNonConjunctionResult( SearchLuceneInterface  $reader)
    {
     ...
     * @return float
     */
    public function _conjunctionScore($docId,  SearchLuceneInterface  $reader)
    {
        if ($this->_coord === null) {
