...
/**  SearchLuceneSearchSimilarityDefault  */
...
use Zend\Search\Lucene\Search\Similarity\SimilarityDefault as SearchLuceneSearchSimilarityDefault;
...
abstract class  Similarity 
{
    ...
    public static function getDefault()
    {
        if (!self::$_defaultImpl instanceof  Similarity ) {
            self::$_defaultImpl = new  SearchLuceneSearchSimilarityDefault ();
        }
     ...
     */
    public function idf($input,  SearchLuceneInterface  $reader)
    {
        if (!is_array($input)) {
