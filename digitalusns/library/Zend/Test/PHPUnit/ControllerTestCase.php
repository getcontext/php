...
use Zend\Test\PHPUnit\Constraint\ResponseHeader as ResponseHeader;
use Zend\Test\PHPUnit\Constraint\DomQuery as DomQuery;
use Zend\Test\PHPUnit\Constraint\Redirect as Redirect;
use Zend\Controller\Response\HttpTestCase as ControllerResponseHttpTestCase;
use Zend\Controller\Request\HttpTestCase as ControllerRequestHttpTestCase;
use Zend\Controller\Action\HelperBroker as HelperBroker;
use PHPUnit\Framework\TestCase as TestCase;
use Zend\Controller\Front as Front;
use Zend\Dom\Query as Query;
...
abstract class  ControllerTestCase  extends  TestCase 
{
    ...
    /**
     * @var \Zend\Controller\Request\RequestAbstract
     */
    protected $_request;
    
    /**
     * @var \Zend\Controller\Response\ResponseAbstract
     */
    protected $_response;
    ...
    final public function bootstrap()
    {
        ...
        if (null !== $this->bootstrap) {
            if (is_callable($this->bootstrap)) {
                ...
                if ( Loader ::isReadable($this->bootstrap)) {
     ...
     *
     * @todo   Need to update  Layout  to add a resetInstance() method
     * @return void
     */
    ...
    public function getRequest()
    {
        if (null === $this->_request) {
            ...
            $this->_request = new  ControllerRequestHttpTestCase ;
        }
    ...
    public function getResponse()
    {
        if (null === $this->_response) {
            ...
            $this->_response = new  ControllerResponseHttpTestCase ;
        }
