...
class  Ldap 
{
    ...
    public function setOptions(array $options)
    {
        ...
        if ($diff) {
            ...
            throw new  LdapException (null, "Unknown  Ldap  option: $key");
        }
        ...
        foreach ($permittedOptions as $key => $val) {
            if (!array_key_exists($key, $options)) {
                ...
                /* Enforce typing. This eliminates issues like \Zend\Config\Ini
    ...
    private function _getAccount($acctname, array $attrs = null)
    {
         ...
         */
        require_once 'Zend/Ldap/Exception.php';
        throw new  LdapException ($resource, $str, $code);
    }
    ...
    public function connect($host = null, $port = 0, $useSsl = false)
    {
        ...
        if (is_resource($resource) === true) {
            ...
            $zle = new  LdapException ($resource, "$host:$port");
            $this->disconnect();
            throw $zle;
        }
        /**
         ...
         */
        require_once 'Zend/Ldap/Exception.php';
        throw new  LdapException ("Failed to connect to LDAP server: $host:$port");
    }
    ...
    public function bind($username = null, $password = null)
    {
        ...
        if ($username !== null &&
            ...
            switch ( LdapException ::getLdapCode($this)) {
            ...
            $zle = new  LdapException ($this->_resource, $message);
        }
        $this->disconnect();
        throw $zle;
    }
