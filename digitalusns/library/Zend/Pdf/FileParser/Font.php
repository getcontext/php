 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class \Zend\Pdf\FileParser\Font extends \Zend\Pdf\FileParser
{
  /**** Instance Variables ****/
  ...
  /* Object Lifecycle */
     ...
     *
     * @param \Zend\Pdf\FileParserDataSource $dataSource
     * @throws \Zend\Pdf\Exception
     */
    public function __construct(\Zend\Pdf\FileParserDataSource $dataSource)
    {
  ...
  /* Parser Methods */
     ...
     *   Use the BYTE_ORDER_ constants defined in {@link \Zend\Pdf\FileParser}. If
    ...
    public function readStringUTF16($byteCount,
                                    $byteOrder = \Zend\Pdf\FileParser::BYTE_ORDER_BIG_ENDIAN,
                                    $characterSet = '')
    {
  ...
  /* Internal Utility Methods */
    ...
    protected function _debugLog($message)
    {
        ...
        \Zend\Log::log($message, \Zend\Log::LEVEL_DEBUG, 'ZF');
    }
