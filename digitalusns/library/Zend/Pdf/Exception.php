 ...
 * thrown. Example:
 *
 *   throw new  Exception ('foo() is not yet implemented',
...
class  Exception  extends \Zend_Exception
{
  ...
  /* \Zend\Pdf\FileParser\Font and Subclasses */
  ...
  /* \Zend\Pdf\Resource\Font and Subclasses */
