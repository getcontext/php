 ...
 *
 * Factory class which vends  Color  objects from typical HTML
 * representations.
 *
 * @category   Zend
 * @package    \Zend\Pdf
...
use Zend\Pdf\Color\GrayScale as GrayScale;
use Zend\Pdf\Color\Rgb as Rgb;
...
class  Html  extends  Color 
{
    ...
    /**
     * Creates a  Color  object from the HTML representation.
     *
    ...
    /**
     * Creates a  Color  object from the named color.
     *
    ...
    public static function namedColor($color)
    {
        switch (strtolower($color)) {
            ...
            default:
                throw new  PdfException ('Unknown color name: ' . $color);
        }
        if (($r == $g) && ($g == $b)) {
            return new  GrayScale ($r);
        } else {
