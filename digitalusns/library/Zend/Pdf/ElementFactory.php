...
use Zend\Pdf\ElementFactory\Proxy as Proxy;
use Zend\Pdf\UpdateInfoContainer as UpdateInfoContainer;
...
class  ElementFactory  implements  PdfElementFactoryInterface 
{
    /**
     * List \of the modified objects.
     * Also contains new and removed objects
     *
     * Array: ojbectNumber =>  Object 
     *
     * @var array
     */
     ...
     * Array \of  PdfElementFactoryInterface  objects
     *
     * @var array
     */
     ...
     *
     * @param integer $objCount
     * @return  PdfElementFactoryInterface 
     */
    ...
    public function getEnumerationShift( PdfElementFactoryInterface  $factory)
    {
        if (($shift = $this->calculateShift($factory)) == -1) {
            throw new  PdfException ('Wrong object context');
        }
    ...
    public function markAsModified( Object  $obj)
    {
        if ($obj->getFactory() !== $this) {
            throw new  PdfException ('Object is not generated by this factory');
        }
    ...
    {
        $obj = new  Object ($objectValue, $this->_objectCount++, 0, $this);
        $this->_modifiedObjects[$obj->getObjNum()] = $obj;
        return $obj;
    }
    ...
    {
        $obj = new  Stream ($streamValue, $this->_objectCount++, 0, $this);
        $this->_modifiedObjects[$obj->getObjNum()] = $obj;
        return $obj;
    }
     ...
     * Returns array \of  UpdateInfoContainer 
     *
     * @param  PdfElementFactoryInterface  $rootFactory
     * @return array
     */
