...
class  AsciiHex  implements  PdfFilterInterface 
{
    /**
     * Encode data
     *
    ...
    public static function decode($data, $params = null)
    {
            ...
            switch ($charCode) {
                ...
                default:
                    if ($charCode >= 0x30 /*'0'*/ && $charCode <= 0x39 /*'9'*/) {
                        ...
                        throw new  PdfException ('Wrong character in a encoded stream');
                    }
        ...
        if ($data[$count] != '>') {
            throw new  PdfException ('Wrong encoded stream End Of \Data marker.');
        }
