 ...
 * It's used by  PdfPage  class in draw operations.
 *
 * @package    \Zend\Pdf
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
...
class  Style 
{
    ...
    {
        $this->_lineWidth = new  Numeric ($width);
    }
    ...
    {
        if ($pattern ===  PdfPage ::LINE_DASHING_SOLID) {
            $pattern = array();
            $phase   = 0;
        }

        $this->_lineDashingPattern = $pattern;
        $this->_lineDashingPhase   = new  Numeric ($phase);
    }
