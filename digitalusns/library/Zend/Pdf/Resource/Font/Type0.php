 ...
 * objects called CIDFonts ({@link  CidFont }), organized hierarchically.
...
use Zend\Pdf\Resource\Font\CidFont as CidFont;
...
class  Type0  extends  PdfResourceFont 
{
	/**
	 * Descendant CIDFont
	 * 
     ...
     *
     */
    public function __construct( CidFont  $descendantFont)
    {
        parent::__construct();
        
        $this->_objectFactory->attach($descendantFont->getFactory());
        
        $this->_fontType       =  PdfFont ::TYPE_TYPE_0;
        ...
        $this->_resource->Subtype         = new  Name ('Type0');
        $this->_resource->BaseFont        = new  Name ($descendantFont->getResource()->BaseFont->value);
        $this->_resource->DescendantFonts = new  PdfElementArray (array( $descendantFont->getResource() ));
        $this->_resource->Encoding        = new  Name ('Identity-H');
     ...
     *
     * \Zend\Pdf uses 'Identity-H' encoding \for Type 0 fonts.
