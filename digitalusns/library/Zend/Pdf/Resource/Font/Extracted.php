...
class  Extracted  extends  PdfResourceFont 
{
    /**
     ...
     * Object constructor
     * 
     * $fontDictionary is a \Zend\Pdf\Element\Reference or \Zend\Pdf\Element\Object object
     *
    ...
    public function __construct($fontDictionary)
    {
        ...
        switch ($fontDictionary->Subtype->value) {
            case 'Type0':
                ...
                if ($fontDictionary->DescendantFonts->items->count() != 1) {
                    ...
                    throw new  PdfException ('Unsupported font type.');
                }
            ...
            case 'Type1':
                if ($fontDictionary->FontDescriptor === null) {
                    ...
                    $standardFont =  PdfFont ::fontWithName($fontDictionary->BaseFont->value);
        ...
        $this->_fontNames[ PdfFont ::NAME_POSTSCRIPT]['en'] = iconv('UTF-8', 'UTF-16BE', $fontDictionary->BaseFont->value);
    ...
    {
        throw new  PdfException ('Operation is not supported \for extracted fonts');
    }
    ...
    public function encodeString($string, $charEncoding)
    {
        ...
        throw new  PdfException ('Fonf encoding is not supported');
    }
