 ...
 *   and PDFDocEncoding, but \Zend\Pdf simple fonts implementation operates only with 
...
abstract class  Simple  extends  PdfResourceFont 
{
    /**
     ...
     *
     * Keys are integers starting from 0, which coresponds to  Cmap ::MISSING_CHARACTER_GLYPH.
     *
  ...
  /* Object Lifecycle */
    ...
    public function __construct()
    {
         ...
         */
        $this->_resource->Encoding = new  Name ('WinAnsiEncoding');
    }
