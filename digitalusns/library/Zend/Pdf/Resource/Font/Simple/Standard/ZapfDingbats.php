...
use Zend\Pdf\Resource\Font\Simple\Standard as Standard;
...
class  ZapfDingbats  extends  Standard 
{
  ...
  /* Object Lifecycle */
    ...
    public function __construct()
    {
         ...
         */
        $this->_fontNames[ Font ::NAME_COPYRIGHT]['en'] =
        ...
        $this->_cmap =  Cmap ::cmapWithTypeData(
           Cmap ::TYPE_BYTE_ENCODING_STATIC, $cmapData);
         ...
         */
        $this->_resource->BaseFont = new  Name ('ZapfDingbats');
    ...
    public function encodeString($string, $charEncoding)
    {
        ...
        \for ($i = 0; $i < strlen($string); $i++) {
            ...
            if (isset($this->_toFontEncoding[$characterCode])) {
                ...
                /* For now, mimic the behavior in  Font ::encodeString()
