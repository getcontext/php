 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class \Zend\Pdf\FileParserDataSource_String extends \Zend\Pdf\FileParserDataSource
{
  /**** Instance Variables ****/
  ...
  /* Concrete Class Implementation */
    ...
    {
        if (empty($string)) {
            throw new \Zend\Pdf\Exception('String is empty',
                                         \Zend\Pdf\Exception::PARAMETER_VALUE_OUT_OF_RANGE);
        }
