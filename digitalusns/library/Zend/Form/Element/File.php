 ...
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: File.php 10656 2008-08-05 02:16:02Z matthew $
 */


use Zend\File\Transfer\Adapter\AdapterAbstract as FileTransferAdapterAbstract;
...
class  File  extends  Xhtml 
{
    ...
    /**
     * @var  FileTransferAdapterAbstract 
     */
    protected $_adapter;
     ...
     * 
     * @param  string| FileTransferAdapterAbstract  $adapter 
     * @return  File 
     */
    public function setTransferAdapter($adapter)
    {
        if ($adapter instanceof  FileTransferAdapterAbstract ) {
            ...
            throw new  FormElementException ('Invalid adapter specified');
        }
     ...
     * 
     * @return  FileTransferAdapterAbstract 
     */
