...
class  Element  implements  ValidateInterface 
{
    /**
     * Element Constants
     */
     ...
     * @return void
     * @throws  FormException  if no element name after initialization
     */
    public function __construct($spec, $options = null)
    {
        ...
        if (null === $this->getName()) {
            ...
            throw new  FormException ('\Zend\Form\Element requires each element to have a name');
        }
     ...
     * @param  mixed $value 
     * @return  Element 
     * @throws  FormException  \for invalid $name values
     */
    public function setAttrib($name, $value)
    {
        ...
        if ('_' == $name[0]) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException (sprintf('Invalid attribute "%s"; must not contain a leading underscore', $name));
        }
    ...
    public function __get($key)
    {
        if ('_' == $key[0]) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException (sprintf('Cannot retrieve value \for protected/private property "%s"', $key));
        }
     ...
     */
    public function setPluginLoader( LoaderPluginLoaderInterface  $loader, $type)
    {
     ...
     * 
     * @param  string| ValidateInterface  $validator 
     * @param  bool $breakChainOnFailure
     * @param  array $options 
     * @return  Element 
     * @throws  FormException  if invalid validator type
     */
    public function addValidator($validator, $breakChainOnFailure = false, $options = array())
    {
        if ($validator instanceof  ValidateInterface ) {
            ...
            require_once 'Zend/Form/Exception.php';
            throw new  FormException ('Invalid validator provided to addValidator; must be string or \Zend\Validate\ValidateInterface');
        }
    ...
    public function addValidators(array $validators)
    {
        foreach ($validators as $validatorInfo) {
            if (is_string($validatorInfo)) {
                ...
                require_once 'Zend/Form/Exception.php';
                throw new  FormException ('Invalid validator passed to addValidators()');
            }
        }
     ...
     * 
     * @param  string $name 
     * @return  ValidateInterface |false False if not found, validator otherwise
     */
    ...
    public function addFilter($filter, $options = array())
    {
        if ($filter instanceof  FilterInterface ) {
            ...
            require_once 'Zend/Form/Exception.php';
            throw new  FormException ('Invalid filter provided to addFilter; must be string or \Zend\Filter\FilterInterface');
        }
    ...
    public function addFilters(array $filters)
    {
        foreach ($filters as $filterInfo) {
            if (is_string($filterInfo)) {
                ...
                require_once 'Zend/Form/Exception.php';
                throw new  FormException ('Invalid filter passed to addFilters()');
            }
        }
    ...
    protected function _loadFilter(array $filter)
    {
        ...
        if (array_key_exists($name, $this->_filters)) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException (sprintf('Filter instance already exists \for filter "%s"', $origName));
        }
    ...
    protected function _loadValidator(array $validator)
    {
        ...
        if (array_key_exists($name, $this->_validators)) {
            require_once 'Zend/Form/Exception.php';
            throw new  FormException (sprintf('Validator instance already exists \for validator "%s"', $origName));
        }
