...
class  DisplayGroup  implements \Iterator,\Countable
{
     ...
     * @return  DisplayGroup 
     * @throws  FormException  if any element is not a  Element 
     */
    public function addElements(array $elements)
    {
        foreach ($elements as $element) {
            if (!$element instanceof  Element ) {
                require_once 'Zend/Form/Exception.php';
                throw new  FormException ('elements passed via array to addElements() must be  Element s only');
            }
    ...
    {
        if ((null === $translator) || ($translator instanceof  Adapter )) {
