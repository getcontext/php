...
/**
 * \Zend\Form_Decorator_Element_HtmlTag
 *
...
use Zend\Filter\StringToLower as StringToLower;
...
class  HtmlTag  extends \\Zend\Form_Decorator_Abstract
{
    /**
    ...
    public function normalizeTag($tag)
    {
        if (!isset($this->_tagFilter)) {
            ...
            $this->_filter->addFilter(new  Alnum ())
                          ->addFilter(new  StringToLower ());
        }
