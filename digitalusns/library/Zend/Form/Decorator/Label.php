...
use Zend\Form\Decorator\HtmlTag as HtmlTag;
use Zend\Form\Exception as FormException;




class  Label  extends \\Zend\Form_Decorator_Abstract
{
    /**
     ...
     * @param  array $args 
     * @return mixed
     * @throws  FormException  \for unsupported methods
     */
                ...
                || ('Suffix' == substr($method, -6))))
        {
            ...
            switch ($type) {
                ...
                default:
                    ...
                    throw new  FormException (sprintf('Invalid method "%s" called in Label decorator', $method));
            }
