...
class  ViewHelper  extends \\Zend\Form_Decorator_Abstract
{
    /**
     ...
     * 
     * @param  string $helper 
     * @return \Zend\Form_Decorator_Element_ViewHelper
     */
     ...
     * Get name
     *
     * If element is a  Element , will attempt to namespace it if the 
     ...
     * @return string
     * @throws  FormDecoratorException  if element or view are not registered
     */
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new  FormDecoratorException ('ViewHelper decorator cannot render without a registered view object');
        }
