...
/**
 * @see  GdataKindEventEntry 
 */
require_once 'Zend/Gdata/Kind/EventEntry.php';

/**
 * @see  SendEventNotifications 
 */
...
use Zend\Gdata\Calendar\Extension\SendEventNotifications as SendEventNotifications;
use Zend\Gdata\Calendar\Extension\Timezone as Timezone;
use Zend\Gdata\Calendar\Extension\QuickAdd as QuickAdd;
use Zend\Gdata\Calendar\Extension\Link as Link;
use Zend\Gdata\Kind\EventEntry as GdataKindEventEntry;
use Zend\Gdata\Calendar as Calendar;




class  EventEntry  extends  GdataKindEventEntry 
{
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        switch ($absoluteNodeName) {
            case $this->lookupNamespace('gCal') . ':' . 'sendEventNotifications';
                $sendEventNotifications = new  SendEventNotifications ();
