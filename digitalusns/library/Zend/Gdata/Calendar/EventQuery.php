...
use Zend\Gdata\App\Util as Util;
...
class  EventQuery  extends  Query 
{
    ...
    /**
     * @param string $value
     * @return  EventQuery  Provides a fluent interface
     */
    ...
    {
        if ($value != null) {
            $this->_params['start-max'] =  Util ::formatTimestamp($value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['start-min'] =  Util ::formatTimestamp($value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['recurrence-expansion-start'] =  Util ::formatTimestamp($value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['recurrence-expansion-end'] =  Util ::formatTimestamp($value);
        } else {
