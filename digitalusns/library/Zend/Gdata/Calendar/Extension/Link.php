...
use Zend\Gdata\Calendar\Extension\Webcontent as Webcontent;
...
class  Link  extends  GdataAppExtensionLink 
{
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('gCal') . ':' . 'webContent':
            $webContent = new  Calendar _Extension_WebContent();
     ...
     *
     * @param  Calendar _Extension_WebContent $value The desired value \for this attribute.
