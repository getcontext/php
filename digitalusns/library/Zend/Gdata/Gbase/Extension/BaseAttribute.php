...
use Zend\Gdata\Gbase as Gbase;




class  BaseAttribute  extends  Element 
{
    ...
    {
        foreach ( Gbase ::$namespaces as $nsPrefix => $nsUri) {
     ...
     *
     * @param  Element  $attribute The attribute object
     * @param string $name The name \of the Base attribute
     * @return \Zend\Gdata\Extension_ItemEntry Provides a fluent interface
     */
