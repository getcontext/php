...
use Zend\Gdata\App\CaptchaRequiredException as CaptchaRequiredException;
        ...
        $accountType = 'HOSTED_OR_GOOGLE')
    {
        ...
        if (!$client instanceof  Client ) {
            ...
            throw new  HttpException (
                    'Client is not an instance \of  Client .');
        }

        // Build the HTTP client \for authentication
        $client->setUri($loginUri);
        $useragent = $source . ' Zend_Framework_Gdata/' .  Version ::VERSION;
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once 'Zend/Gdata/App/AuthException.php';
                throw new  AuthException ('Authentication with Google failed. Reason: ' .
