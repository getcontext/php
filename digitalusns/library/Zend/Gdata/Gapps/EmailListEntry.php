 ...
 * described by instances \of  Gapps _EmailListRecipient. Multiple 
 * entries are contained within instances \of  Gapps _EmailListFeed.
 * 
...
use Zend\Gdata\Gapps\Extension\EmailList as EmailList;
...
class  EmailListEntry  extends  Entry 
{
     ...
     *
     * @see setEmailList
     * @return  EmailList  The requested object 
     *              or null if not set.
     */
     ...
     * protocol.
     * 
     * @param  EmailList  $value The desired value 
     ...
     * protocol.
     * 
     * @param array $value A collection \of  Gapps _Extension_FeedLink 
