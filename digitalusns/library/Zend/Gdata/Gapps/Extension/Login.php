...
class  Login  extends  Extension 
{
    ...
    protected function takeAttributeFromDOM($attribute)
    {
        ...
        case 'admin':
            if ($attribute->nodeValue == "true") {
                ...
                throw new  GdataAppInvalidArgumentException ("Expected 'true' or 'false' \for apps:login#admin.");
            }
            break;
        case 'agreedToTerms':
            if ($attribute->nodeValue == "true") {
                ...
                require_once('Zend/Gdata/App/InvalidArgumentException.php');
                throw new  GdataAppInvalidArgumentException ("Expected 'true' or 'false' \for apps:login#agreedToTerms.");
            }
            break;
        case 'suspended':
            if ($attribute->nodeValue == "true") {
                ...
                require_once('Zend/Gdata/App/InvalidArgumentException.php');
                throw new  GdataAppInvalidArgumentException ("Expected 'true' or 'false' \for apps:login#suspended.");
            }
            break;
        case 'changePasswordAtNextLogin':
            if ($attribute->nodeValue == "true") {
                ...
                require_once('Zend/Gdata/App/InvalidArgumentException.php');
                throw new  GdataAppInvalidArgumentException ("Expected 'true' or 'false' \for apps:login#changePasswordAtNextLogin.");
            }
            break;
        default:
     ...
     * @return  Login  Provides a fluent interface.
     */
    ...
    public function getAdmin()
    {
        if (!(is_bool($this->_admin))) {
            require_once('Zend/Gdata/App/InvalidArgumentException.php');
            throw new  GdataAppInvalidArgumentException ('Expected boolean \for admin.');
        }
        return $this->_admin;
    }
    ...
    public function setAdmin($value)
    {
        if (!(is_bool($value))) {
            require_once('Zend/Gdata/App/InvalidArgumentException.php');
            throw new  GdataAppInvalidArgumentException ('Expected boolean \for $value.');
        }
        $this->_admin = $value;
        return $this;
    }
    ...
    public function getAgreedToTerms()
    {
        if (!(is_bool($this->_agreedToTerms))) {
            require_once('Zend/Gdata/App/InvalidArgumentException.php');
            throw new  GdataAppInvalidArgumentException ('Expected boolean \for agreedToTerms.');
        }
    ...
    public function getSuspended()
    {
        if (!(is_bool($this->_suspended))) {
            require_once('Zend/Gdata/App/InvalidArgumentException.php');
            throw new  GdataAppInvalidArgumentException ('Expected boolean \for suspended.');
        }
    ...
    public function getChangePasswordAtNextLogin()
    {
        if (!(is_bool($this->_changePasswordAtNextLogin))) {
            require_once('Zend/Gdata/App/InvalidArgumentException.php');
            throw new  GdataAppInvalidArgumentException ('Expected boolean \for changePasswordAtNextLogin.');
        }
