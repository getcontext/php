...
class  ServiceException  extends \Zend_Exception
{
    ...
    /** 
     * Array \of \Zend\Gdata_Error objects indexed by error code.
     * 
     * @var array
     */
     ...
     * server.
     * 
     * @param  Error  $error An instance \of an error returned 
    ...
    public function addError($error) {
        ...
        if ($error->getErrorCode() == null) {
            ...
            throw new  GdataAppException ("Error encountered without corresponding error code.");
        }
     ...
     *           Error  objects. All errors must have their 
     *          errorCode value set.
     * @throws  GdataAppException 
     */
     ...
     *           Error  objects, indexed by error code.
     */
     ...
     *
     * @return  Error  The Error object requested, or null 
     *              if not found.
     */
     ...
     * @return  ServiceException  Provides a fluent interface.
     * @throws  GdataAppException 
     */
    public function importFromString($string) {
        if ($string) {
            ...
            require_once 'Zend/Gdata/App/Exception.php';
            throw new  GdataAppException ('XML passed to transferFromXML cannot be null');
        }
