...
class  ListQuery  extends  Query 
{
    ...
    /**
     * Constructs a new  ListQuery  object.
     */
     ...
     * @return  ListQuery  Provides a fluent interface
     */
    ...
    public function getQueryUrl()
    {
        ...
        if ($this->_spreadsheetKey != null) {
            ...
            throw new  GdataAppException ('A spreadsheet key must be provided \for list queries.');
        }
        ...
        if ($this->_worksheetId != null) {
            ...
            require_once 'Zend/Gdata/App/Exception.php'; 
            throw new  GdataAppException ('A worksheet id must be provided \for list queries.');
        }
        ...
        if ($this->_visibility != null) {
            ...
            require_once 'Zend/Gdata/App/Exception.php'; 
            throw new  GdataAppException ('A visibility must be provided \for list queries.');
        }
        ...
        if ($this->_projection != null) {
            ...
            require_once 'Zend/Gdata/App/Exception.php'; 
            throw new  GdataAppException ('A projection must be provided \for list queries.');
        }
