...
class  CellQuery  extends  Query 
{
    ...
    /**
     * Constructs a new  CellQuery  object.
     *
     ...
     *
     * @param string $value
     * @return  CellQuery  Provides a fluent interface
     */
    ...
    public function getQueryUrl()
    {
        if ($this->_url == null) {
            ...
            if ($this->_spreadsheetKey != null) {
                ...
                throw new  GdataAppException ('A spreadsheet key must be provided \for cell queries.');
            }
            ...
            if ($this->_worksheetId != null) {
                ...
                require_once 'Zend/Gdata/App/Exception.php';
                throw new  GdataAppException ('A worksheet id must be provided \for cell queries.');
            }
            ...
            if ($this->_visibility != null) {
                ...
                require_once 'Zend/Gdata/App/Exception.php';
                throw new  GdataAppException ('A visibility must be provided \for cell queries.');
            }
            ...
            if ($this->_projection != null) {
                ...
                require_once 'Zend/Gdata/App/Exception.php';
                throw new  GdataAppException ('A projection must be provided \for cell queries.');
            }
