...
class  ListEntry  extends  Entry 
{
    ...
    /**
     * List \of custom row elements ( Custom ),
    ...
    /**
     * Constructs a new  ListEntry  object.
    ...
    protected function takeChildFromDOM($child)
    {
        ...
        case $this->lookupNamespace('gsx');
            $custom = new  Custom ($child->localName);
     ...
     * @param  Custom  $custom The custom
     *             element to be added.
     * @return  ListEntry  Provides a fluent interface.
     */
