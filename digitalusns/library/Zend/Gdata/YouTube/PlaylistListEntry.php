...
class  PlaylistListEntry  extends  Entry 
{
     ...
     *
     * @param  Description  $description The description relating to the video
     * @return  PlaylistListEntry  Provides a fluent interface
     */ 
     ...
     *
     * @return  Description   The description relating to the video 
     */
