...
/**
 * @see  GdataMediaExtensionMediaContent 
 */
 ...
 * media:group (\Zend\Gdata\Media\Extension\MediaGroup) element.
 *
 * @category   Zend
 * @package    \Zend\Gdata
 * @copyright  Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
...
use Zend\Gdata\Media\Extension\MediaContent as GdataMediaExtensionMediaContent;
use Zend\Gdata\YouTube as YouTube;




class  MediaContent  extends  GdataMediaExtensionMediaContent 
{
     ...
     * @return  MediaContent   Provides a fluent interface
     *
     */
