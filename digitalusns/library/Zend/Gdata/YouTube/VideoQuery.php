...
class  VideoQuery  extends  Query 
{
    ...
    public function setFeedType($feedType, $videoId = null, $entry = null)
    {
        ...
        case 'related':
            if ($videoId === null) {
                ...
                throw new  GdataAppException ('Video ID must be set \for feed \of type: ' . $feedType);
            } else {
                $this->_url =  YouTube ::VIDEO_URI . '/' . $videoId . '/related';
            }
            break;
        case 'responses':
            if ($videoId === null) {
                ...
                $this->_url =  YouTube ::VIDEO_URI . '/' . $videoId . 'responses';
            }
            break;
        case 'comments':
            if ($videoId === null) {
                ...
                $this->_url =  YouTube ::VIDEO_URI . '/' . $videoId . 'comments';
                if ($entry !== null) {
                    $this->_url .= '/' . $entry;
                }
            }
        ...
        default:
            require_once 'Zend/Gdata/App/Exception.php';
            throw new  GdataAppException ('Unknown feed type');
            break;
        }
    }
     ...
     *
     * @param string $value
     * @return  VideoQuery  Provides a fluent interface
     */
    public function setTime($value = null)
    {
        switch ($value) {
            ...
            default:
                require_once 'Zend/Gdata/App/Exception.php';
                throw new  GdataAppException ('Unknown time value');
                break;
        }
        return $this;
    }
    ...
    /**
     * @param string $value
     * @return  YouTube _Query Provides a fluent interface
     */
