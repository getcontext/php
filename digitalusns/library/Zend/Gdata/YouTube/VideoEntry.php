...
use Zend\Gdata\Media\Extension\MediaDescription as MediaDescription;
use Zend\Gdata\YouTube\Extension\RecordingDate as RecordingDate;
use Zend\Gdata\Media\Extension\MediaKeywords as MediaKeywords;
use Zend\Gdata\Media\Extension\MediaCategory as MediaCategory;
use Zend\Gdata\YouTube\Extension\MediaGroup as MediaGroup;
use Zend\Gdata\YouTube\Extension\Statistics as Statistics;
use Zend\Gdata\Media\Extension\MediaTitle as MediaTitle;
use Zend\Gdata\YouTube\Extension\ExtensionPrivate as GdataYouTubeExtensionPrivate;
use Zend\Gdata\YouTube\Extension\Control as Control;
use Zend\Gdata\YouTube\Extension\NoEmbed as NoEmbed;
use Zend\Gdata\Geo\Extension\GeoRssWhere as GeoRssWhere;
use Zend\Gdata\YouTube\Extension\Racy as Racy;
use Zend\Gdata\YouTube\Extension\Link as Link;
use Zend\Gdata\Extension\Comments as Comments;
use Zend\Gdata\Extension\FeedLink as FeedLink;
use Zend\Gdata\YouTube\MediaEntry as MediaEntry;
use Zend\Gdata\Extension\Rating as Rating;
...
class  VideoEntry  extends  MediaEntry 
{
     ...
     *
     * @var  GdataYouTubeExtensionPrivate 
     */
     ...
     *
     * @var \Zend\Gdata\Extensions_Comments
     */
     ...
     *
     * @param  RecordingDate  $recordingDate When the video was recorded
     * @return  VideoEntry  Provides a fluent interface
     */
    ...
    /**
     * If an instance \of  NoEmbed  is passed in,
     ...
     *
     * @param  NoEmbed  $noEmbed Whether or not the video can be embedded
     * @return  VideoEntry  Provides a fluent interface
     */
     ...
     *  NoEmbed , this video cannot be embedded.
     * TODO: Make it easier to get/set this data
     *
     * @return  NoEmbed  Whether or not the video can be embedded
     */
     ...
     *
     * @param  Statistics  $statistics The statistics relating to the video
     * @return  VideoEntry  Provides a fluent interface
     */
     ...
     *
     * @return  Statistics   The statistics relating to the video
     */
     ...
     *
     * @param  Racy  $racy The racy flag object
     * @return  VideoEntry  Provides a fluent interface
     */
     ...
     *
     * @return  Racy   The racy flag object
     */
     ...
     *
     * @param  Rating  $rating The rating relating to the video
     * @return  VideoEntry  Provides a fluent interface
     */
     ...
     *
     * @return  Rating   The rating relating to the video
     */
     ...
     *
     * @param  Comments  $comments The comments relating to the video
     * @return  VideoEntry  Provides a fluent interface
     */
     ...
     *
     * @return  Comments   The comments relating to the video
     */
    ...
    public function getVideoId()
    {
        ...
        if ($position === false) {
            ...
            throw new  GdataAppException ('Slash not found in atom:id');
        } else {
     ...
     *
     * @param  GeoRssWhere  $value The georss:where class value
     * @return  VideoEntry  Provides a fluent interface
     */
    ...
    {
        $this->ensureMediaGroupIsNotNull();
        $this->getMediaGroup()->setTitle(new  MediaTitle ($title));
        return $this;
    }
    ...
    {
        $this->ensureMediaGroupIsNotNull();
        $this->getMediaGroup()->setDescription(new  MediaDescription ($description));
        return $this;
    }
    ...
    {
        $this->ensureMediaGroupIsNotNull();
        $this->getMediaGroup()->setPrivate(new  GdataYouTubeExtensionPrivate ());
        return $this;
    }
    ...
    {
        $this->ensureMediaGroupIsNotNull();
        $this->getMediaGroup()->setCategory(array(new  MediaCategory ($category, self::YOUTUBE_CATEGORY_SCHEMA)));
        return $this;
    }
    ...
    {
        $this->ensureMediaGroupIsNotNull();
        $newCategory = new  MediaCategory ($developerTag, self::YOUTUBE_DEVELOPER_TAGS_SCHEMA);
     ...
     *
     * @return  YouTube _Extension_State The publishing state \of this video
     */
    ...
    /**
     * Get the VideoEntry's  MediaGroup  object. 
    ...
    {   
        if ($this->getMediagroup() == null) {
            $this->setMediagroup(new  MediaGroup ());
        }
    }
