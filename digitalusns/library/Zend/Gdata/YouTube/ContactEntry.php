...
use Zend\Gdata\YouTube\UserProfileEntry as UserProfileEntry;
use Zend\Gdata\YouTube\Extension\Status as Status;
...
class  ContactEntry  extends  UserProfileEntry 
{
     ...
     * @return  ContactEntry  Provides a fluent interface
     */
