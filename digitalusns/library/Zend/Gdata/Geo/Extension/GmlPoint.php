...
use Zend\Gdata\Geo\Extension\GmlPos as GmlPos;
...
class  GmlPoint  extends  Extension 
{
     ...
     * 
     * @param  GmlPos  $pos (optional) Pos to which this
     ...
     *
     * @see setPos
     * @return  GmlPos  The requested attribute.
     */
     ...
     *
     * @param  GmlPos  $value The desired value \for this attribute
     * @return  GmlPoint  Provides a fluent interface
     */
