...
class  HttpClient  extends  Client 
{
     ...
     * installation.  Otherwise, a  GdataAppInvalidArgumentException 
     * will be thrown.
     *
     * @param string $key The private key
     * @param string $passphrase The optional private key passphrase
     * @throws  GdataAppInvalidArgumentException 
     * @return  HttpClient  Provides a fluent interface
     */
     ...
     * @throws  GdataAppException  if there was a signing failure
     ...
     * currently done.
     *
     * @param  Response  $response The response object to filter
     * @return  Response  The filterd response object
     */
