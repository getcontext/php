...
use Zend\Gdata\App\FeedSourceParent as FeedSourceParent;
        ...
        implements \Iterator, \ArrayAccess
{
     ...
     * atom:feed representation
     *
     * @param array $value The array \of  Entry  elements
     * @return  Feed  Provides a fluent interface
     */
     ...
     *
     * @param  Entry  An individual entry to add.
     * @return  Feed  Provides a fluent interface
     */
