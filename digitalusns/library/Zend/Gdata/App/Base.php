...
use Zend\Gdata\App\Extension\Element as Element;
...
abstract class  Base 
{
     ...
     * @return  Base  Returns an object \of the same type as 'this' to provide a fluent interface.
     */
    ...
    public function transferFromXML($xml)
    {
        if ($xml) {
            ...
            if (!$element) {
                require_once 'Zend/Gdata/App/Exception.php';
                throw new  GdataAppException ('No root <' . $this->_rootElement . '> element');
            }
