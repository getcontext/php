...
/**
 * Wrapper around  Client  to facilitate Google's "Account Authentication
...
use Zend\Gdata\App\AuthException as AuthException;
...
class  AuthSub 
{
     ...
     * @param  Client  $client (optional) HTTP client to use to 
     *                                 make the request
     ...
     * @param  Client  $client (optional) HTTP client to use to make the request
    ...
    public static function getHttpClient($token, $client = null)
    {
        ...
        if (!$client instanceof  Client ) {
            require_once 'Zend/Gdata/App/HttpException.php';
            throw new  HttpException ('Client is not an instance \of  Client .');
        }
