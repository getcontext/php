...
class  Query 
{
    ...
    {
        if ($value != null) {
            $this->_params['updated-max'] =  Util ::formatTimestamp($value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['updated-min'] =  Util ::formatTimestamp($value);
        } else {
    ...
    {
        if ($value !== null) {
            $this->_params['published-max'] =  Util ::formatTimestamp($value);
        } else {
    ...
    {
        if ($value != null) {
            $this->_params['published-min'] =  Util ::formatTimestamp($value);
        } else {
    ...
    public function __get($name)
    {
        ...
        if (method_exists($this, $method)) {
            ...
            throw new  GdataAppException ('Property ' . $name . '  does not exist');
        }
    }
