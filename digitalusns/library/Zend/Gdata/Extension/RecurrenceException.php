...
class  RecurrenceException  extends  Extension 
{
    ...
    /**
     * Constructs a new  RecurrenceException  object.
     * @param bool $specialized (optional) Whether this is a specialized exception or not.
     * @param \Zend\Gdata\EntryLink (optional) An Event entry with details about the exception.
     * @param \Zend\Gdata_OriginalEvent (optional) The origianl recurrent event this is an exeption to.
     */
     ...
     * @return  RecurrenceException  The element being modified.
     */
     ...
     *
     * @return  EntryLink  The requested attribute.
     */
     ...
     * Get the value \for this element's Specialized attribute.
     *
     * @return  OriginalEvent  The requested attribute.
     */
     ...
     * Set the value \for this element's Specialized attribute.
     *
     * @param  OriginalEvent  $value The desired value \for this attribute.
     * @return  RecurrenceException  The element being modified.
     */
