...
/**
 * @see  Docs _DocumentListFeed
 */
require_once 'Zend/Gdata/Docs/DocumentListFeed.php';

/**
 * @see  Docs _DocumentListEntry
 */
...
class  Docs  extends  Gdata 
{
     ...
     * @return  Docs _DocumentListEntry
     */
     ...
     * @return  Docs _DocumentListEntry The entry \for the newly 
     ...
     *
     * @param mixed  $data The  Docs _DocumentListEntry or media 
     ...
     *         The default is a '\Zend\Gdata\Docs\DocumentListEntry'.
     * @return  Docs _DocumentListEntry The entry returned by the 
