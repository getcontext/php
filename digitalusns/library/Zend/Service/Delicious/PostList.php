...
class  PostList  implements \Countable, \Iterator, \ArrayAccess
{
    ...
    /**
     * @var  Delicious  Service that has downloaded the post list
     */
    protected $_service;
    ...
    /**
     * @param   Delicious  $service Service that has downloaded the post
    ...
    public function offsetSet($offset, $value)
    {
        ...
        throw new  ServiceDeliciousException ('You are trying to set read-only property');
    }
    ...
    public function offsetUnset($offset)
    {
         ...
         */
        require_once 'Zend/Service/Delicious/Exception.php';
        throw new  ServiceDeliciousException ('You are trying to unset read-only property');
    }
}
