...
use Zend\Service\Amazon\ResultSet as ResultSet;
use Zend\Service\Amazon\Item as Item;
...
class  Amazon 
{
    ...
    public function __construct($appId, $countryCode = 'US')
    {
        ...
        if (!isset($this->_baseUriList[$countryCode])) {
            ...
            throw new  ServiceException ("Unknown country code: $countryCode");
        }
        ...
        $this->_rest = new  Client ($this->_baseUriList[$countryCode]);
    }
