...
use Zend\Service\StrikeIron\Decorator as Decorator;
...
class  Base 
{
    ...
    public function __construct($options = array())
    {
        if (!extension_loaded('soap')) {
            ...
            throw new  ServiceStrikeIronException ('SOAP extension is not enabled');
        }
    ...
    public function __call($method, $params)
    {
        ...
        try {
             ...
             */
            require_once 'Zend/Service/StrikeIron/Exception.php';
            throw new  ServiceStrikeIronException ($message, $e->getCode());
        }
        ...
        if (isset($this->_options['headers'])) {
            ...
            foreach ($this->_options['headers'] as $header) {
                if (! $header instanceof SoapHeader) {
                     ...
                     */
                    require_once 'Zend/Service/StrikeIron/Exception.php';
                    throw new  ServiceStrikeIronException ('Header must be instance \of SoapHeader');
    ...
    public function getSubscriptionInfo($now = false, $queryMethod = 'GetRemainingHits')
    {
        ...
        if (isset($this->_outputHeaders['SubscriptionInfo'])) {
             ...
             */
            require_once 'Zend/Service/StrikeIron/Exception.php';
            throw new  ServiceStrikeIronException ($msg);
        }
