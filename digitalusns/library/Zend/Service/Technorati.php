...
/**
 *  Technorati  provides an easy, intuitive and object-oriented interface 
...
use Zend\Service\Technorati\DailyCountsResultSet as DailyCountsResultSet;
use Zend\Service\Technorati\CosmosResultSet as CosmosResultSet;
use Zend\Service\Technorati\SearchResultSet as SearchResultSet;
use Zend\Service\Technorati\BlogInfoResult as BlogInfoResult;
use Zend\Service\Technorati\TagsResultSet as TagsResultSet;
use Zend\Service\Technorati\GetInfoResult as GetInfoResult;
use Zend\Service\Technorati\KeyInfoResult as KeyInfoResult;
use Zend\Service\Technorati\TagResultSet as TagResultSet;
...
use \prepareOptions as prepareOptions;
...
class  Technorati 
{
    ...
    /**
     * Constructs a new  Technorati  instance
    ...
    public function keyInfo()
    {
        ...
        // and it's already set in # prepareOptions 
    ...
    public function getRestClient()
    {
        if (is_null($this->_restClient)) {
            ...
            $this->_restClient = new  Client (self::API_URI_BASE);
        }
     ...
     * a  ServiceTechnoratiException  exception with Invalid Key message.
     *
     ...
     * @param   array $options
     * @return   Response 
     * @throws   ServiceTechnoratiException  on failure
     * @access  protected
     */
     ...
     * Be aware that  Technorati  supports only XML as format value.
     * 
     * @param   array $options
     * @return  void
     * @throws   ServiceTechnoratiException  if 'format' value != XML
     * @access  protected
     */
     ...
     * @param   array $options
     * @return  void
     * @throws   ServiceTechnoratiException  if 'limit' value is invalid
     * @access  protected
     */
     ...
     * @param   array $options
     * @return  void
     * @throws   ServiceTechnoratiException  if 'start' value is invalid
     * @access  protected
     */
     ...
     * @param   array $options
     * @return  void
     * @throws   ServiceTechnoratiException  if 'url' value is invalid
     * @access  protected
    ...
    protected static function _checkErrors(DomDocument $dom)
    {
        ...
        if ($result->length >= 1) {
             ...
             */
            require_once 'Zend/Service/Technorati/Exception.php';
            throw new  ServiceTechnoratiException ($error);
        }
    }
     ...
     * @return  DOMDocument
     * @throws   ServiceTechnoratiException  if response content contains an error message
     * @access  protected
     */
    ...
    protected static function _checkResponse( Response  $response)
    {
        if ($response->isError()) {
             ...
             */
            require_once 'Zend/Service/Technorati/Exception.php';
            throw new  ServiceTechnoratiException (sprintf(
