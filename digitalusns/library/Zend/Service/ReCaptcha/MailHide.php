...
use Zend\Service\ReCaptcha\MailHide\Exception as ServiceReCaptchaMailHideException;
use Zend\Service\ReCaptcha as ReCaptcha;
...
class  MailHide  extends  ReCaptcha 
{
    ...
    public function __construct($publicKey = null, $privateKey = null, $email = null, $options = null)
    {
        ...
        /* If options is a  Config  object we want to convert it to an array so we can merge it with the default options */
     ...
     *
     * @throws  ServiceReCaptchaMailHideException 
     */
    protected function _requireMcrypt()
    {
        if (!extension_loaded('mcrypt')) {
            /** @see  ServiceReCaptchaMailHideException  */
            require_once 'Zend/Service/ReCaptcha/MailHide/Exception.php';

            throw new  ServiceReCaptchaMailHideException ('Use \of the  MailHide  component requires the mcrypt extension to be enabled in PHP');
        }
    }
    ...
    public function getHtml($email = null)
    {
        if ($email !== null) {
            ...
            throw new  ServiceReCaptchaMailHideException ('Missing email address');
        }
        ...
        if ($this->_publicKey === null) {
            ...
            throw new  ServiceReCaptchaMailHideException ('Missing public key');
        }
        ...
        if ($this->_privateKey === null) {
            ...
            throw new  ServiceReCaptchaMailHideException ('Missing private key');
        }
