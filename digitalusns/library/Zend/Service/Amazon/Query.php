...
use Zend\Service\Amazon as Amazon;
...
class  Query  extends  Amazon 
{
    ...
    public function __call($method, $args)
    {
        ...
        if (strtolower($method) === 'category') {
            ...
            throw new  ServiceException ('You must set a category before setting the search parameters');
        }
     ...
     *
     * @return  Amazon _Item| Amazon _ResultSet
     */
