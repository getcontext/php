...
use Zend\Service\Simpy\WatchlistSet as WatchlistSet;
use Zend\Service\Simpy\LinkQuery as LinkQuery;
use Zend\Service\Simpy\Watchlist as Watchlist;
use Zend\Service\Simpy\LinkSet as LinkSet;
use Zend\Service\Simpy\NoteSet as NoteSet;
use Zend\Service\Simpy\TagSet as TagSet;
...
class  Simpy 
{
    ...
    public function __construct($username, $password)
    {
        ...
        $this->_rest = new  Client ($this->_baseUri);
     ...
     * @return  Simpy  Provides a fluent interface
     */
     ...
     *
     * @param   LinkQuery  $q Query object to use (optional)
     * @return  LinkSet 
     */
     ...
     * @link    Simpy ::ACCESSTYPE_PUBLIC
     * @link    Simpy ::ACCESSTYPE_PRIVATE
