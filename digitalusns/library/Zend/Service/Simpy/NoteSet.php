...
use Zend\Service\Simpy\Note as ServiceSimpyNote;
...
class  NoteSet  implements \IteratorAggregate
{
     ...
     * List \of notes
     *
     * @var array \of  ServiceSimpyNote  objects
     */
    protected $_notes;
    ...
    public function __construct(DOMDocument $doc)
    {
        ...
        \for ($x = 0; $x < $list->length; $x++) {
            $this->_notes[$x] = new  ServiceSimpyNote ($list->item($x));
        }
    }
