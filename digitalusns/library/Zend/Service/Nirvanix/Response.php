...
use Zend\Service\Nirvanix\Exception as ServiceNirvanixException;
...
class  Response 
{
     ...
     * @throws  ServiceNirvanixException 
     */
    ...
    {
        /**
         * @see  ServiceNirvanixException 
         */
        require_once 'Zend/Service/Nirvanix/Exception.php';        

        throw new  ServiceNirvanixException ($message, $code);
    }
