...
use Zend\Service\Nirvanix\Response as ServiceNirvanixResponse;
...
class  Base 
{
     ...
     *
     * @return  ServiceNirvanixResponse 
     */
    public function __call($methodName, $args)
    {
        ...
        $httpResponse = $this->_httpClient->request( Client ::POST);
     ...
     * makes a  ServiceNirvanixResponse  from that XML payload.  
     *
     * @param   HttpResponse   $httpResponse  Raw response from Nirvanix
     * @return  ServiceNirvanixResponse      Wrapped response
     */
    protected function _wrapResponse($httpResponse)
    {
        return new  ServiceNirvanixResponse ($httpResponse->getBody());
    }
}
