...
use Zend\Service\Nirvanix\Namespace\Base as Base;
use Zend\Service\Nirvanix\Response as Response;
...
class  Imfs  extends  Base 
{
    ...
    public function getContents($filePath, $expiration = 3600)
    {
        ...
        $resp = $this->_httpClient->request( Client ::GET);
    ...
    public function putContents($filePath, $data, $mimeType = null)
    {
        ...
        $response = $this->_httpClient->request( Client ::POST);
