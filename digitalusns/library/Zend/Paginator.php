...
use Zend\Paginator\Adapter\DbSelect as DbSelect;
use Zend\Paginator\Adapter\Iterator as PaginatorAdapterIterator;
use Zend\Paginator\Adapter\AdapterArray as PaginatorAdapterArray;
use Zend\Paginator\Adapter\Null as Null;
...
class  Paginator  implements \Countable, \IteratorAggregate
{
    ...
    public static function getScrollingStyleLoader()
    {
        if (self::$_scrollingStyleLoader === null) {
            self::$_scrollingStyleLoader = new  PluginLoader (
                array('\Zend\Paginator_ScrollingStyle' => 'Zend/Paginator/ScrollingStyle')
            );
        }
     ...
     * Factory.
     *
     * @param  array| Select |\Iterator $data
     * @return  Paginator 
    ...
    public static function factory($data)
    {
        if (is_array($data)) {
            /**
             * @see  PaginatorAdapterArray 
             */
            require_once 'Zend/Paginator/Adapter/Array.php';
            
            $paginator = new self(new  PaginatorAdapterArray ($data));
        } else if ($data instanceof  Select ) {
            /**
             * @see  DbSelect 
             */
            require_once 'Zend/Paginator/Adapter/DbSelect.php';
            
            $paginator = new self(new  DbSelect ($data));
        } else if ($data instanceof \Iterator) {
            /**
             * @see  PaginatorAdapterIterator 
             */
            require_once 'Zend/Paginator/Adapter/Iterator.php';
            
            $paginator = new self(new  PaginatorAdapterIterator ($data));
        } else if (is_int($data)) {
            /**
             * @see  Null 
             */
            ...
            $paginator = new self(new  Null ($data));
        } else {
            ...
            throw new  PaginatorException ('No adapter \for type ' . $type);
        }
    ...
    public function getItem($itemNumber, $pageNumber = null)
    {
        ...
        if ($itemCount == 0) {
            ...
            throw new  PaginatorException ('\Page ' . $pageNumber . ' is empty. '
        ...
        if ($itemNumber > $itemCount) {
            ...
            throw new  PaginatorException ('\Page ' . $pageNumber . ' does not'
     ...
     *
     * @param string $scrollingStyle
     * @return  Paginator _ScrollingStyle_Interface
     */
