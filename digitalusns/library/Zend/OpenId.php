...
/**
 * @see  ControllerResponseAbstract 
 */
require_once "Zend/Controller/Response/Abstract.php";

/**
 * Static class that contains common utility functions \for
 * {@link  OpenId _Consumer} and {@link  OpenId _Provider}.
 *
...
use Zend\Controller\Response\Http as Http;
use Zend\OpenId\Exception as OpenIdException;
...
class  OpenId 
{
    ...
    static public function redirect($url, $params = null,
         ControllerResponseAbstract  $response = null, $method = 'GET')
    {
    ...
    static public function digest($func, $data)
    {
        ...
        throw new  OpenIdException (
            'Unsupported digest algorithm "' . $func . '".',
             OpenIdException ::UNSUPPORTED_DIGEST);
    }
...
//        return  Hmac ::compute($secret, $macFunc, $data,  Hmac ::BINARY);
    ...
    static protected function binToBigNum($bin)
    {
        ...
        throw new  OpenIdException (
            'The system doesn\'t have proper big integer extension',
             OpenIdException ::UNSUPPORTED_LONG_MATH);
    }
            ...
            if ($cmp == 0) {
                ...
                throw new  OpenIdException (
                    'Big integer arithmetic error',
                     OpenIdException ::ERROR_LONG_MATH);
            }
            $bin = "";
            while (bccomp($bn, 0) > 0) {
