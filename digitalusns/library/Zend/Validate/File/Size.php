...
class  Size  extends  ValidateAbstract 
{
    ...
    public function setMin($min)
    {
        ...
        if (($this->_max !== null) && ($min > $this->_max)) {
            ...
            throw new  ValidateException ("The minimum must be less than or equal to the maximum filesize, but $min >"
                                            . " {$this->_max}");
        }
    ...
    public function setMax($max)
    {
        ...
        if (($this->_min !== null) && ($max < $this->_min)) {
            require_once 'Zend/Validate/Exception.php';
            throw new  ValidateException ("The maximum must be greater than or equal to the minimum filesize, but "
                                            . "$max < {$this->_min}");
        } else {
            $this->_max = $max;
        }
