...
class  ImageSize  extends  ValidateAbstract 
{
    /**@+
     ...
     * @throws  ValidateException       When minwidth is greater than maxwidth
     * @throws  ValidateException       When minheight is greater than maxheight
    ...
    public function setImageMin($minwidth, $minheight)
    {
        if (($this->_maxwidth !== null) and ($minwidth > $this->_maxwidth)) {
            ...
            throw new  ValidateException ("The minimum image width must be less than or equal to the "
                . " maximum image width, but {$minwidth} > {$this->_maxwidth}");
        }

        if (($this->_maxheight !== null) and ($minheight > $this->_maxheight)) {
            require_once 'Zend/Validate/Exception.php';
            throw new  ValidateException ("The minimum image height must be less than or equal to the "
     ...
     * @throws  ValidateException  When maxwidth is smaller than minwidth
     * @throws  ValidateException  When maxheight is smaller than minheight
     * @return \Zend\Validate\StringLength Provides a fluent interface
     */
    public function setImageMax($maxwidth, $maxheight)
    {
        if ($maxwidth === null) {
            ...
            require_once 'Zend/Validate/Exception.php';
            throw new  ValidateException ("The maximum image width must be greater than or equal to the "
        ...
        if ($maxheight === null) {
            ...
            require_once 'Zend/Validate/Exception.php';
            throw new  ValidateException ("The maximum image height must be greater than or equal to the "
     ...
     * @param  array  $file  File data from \Zend\File\Transfer
     * @return boolean
     */
