...
class  Upload  extends  ValidateAbstract 
{
     ...
     *
     * The array $files must be given in syntax \of \Zend\File\Transfer to be checked
     * If no files are given the $_FILES array will be used automatically.
     * NOTE: This validator will only work with HTTP POST uploads!
     *
     * @param  array $files Array \of files in syntax \of \Zend\File\Transfer
     * @return void
     */
     ...
     * @return array
     * @throws  ValidateException  If file is not found
     */
    public function getFiles($file = null)
    {
        if ($file !== null) {
            ...
            if (count($return) === 0) {
                ...
                throw new  ValidateException ("The file '$file' was not found");
            }
     ...
     *
     * @param  array $files The files to check in syntax \of \Zend\File\Transfer
