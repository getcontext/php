...
class  Count  extends  ValidateAbstract 
{
    /**#@+
     ...
     * @return \Zend\Validate\File\Size Provides a fluent interface
     * @throws  ValidateException  When min is greater than max
     */
    public function setMin($min)
    {
        if ($min === null) {
            ...
            throw new  ValidateException ('The minimum must be less than or equal to the maximum file count, but '
                . " {$min} > {$this->_max}");
        } else {
     ...
     * @throws  ValidateException  When max is smaller than min
    ...
    public function setMax($max)
    {
        if ($max === null) {
            ...
            require_once 'Zend/Validate/Exception.php';
            throw new  ValidateException ("The maximum must be greater than or equal to the minimum file count, but "
                . "{$max} < {$this->_min}");
        } else {
