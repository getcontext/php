...
class  EmailAddress  extends  ValidateAbstract 
{
     ...
     * These bitfields are defined by the ALLOW_* constants in  Hostname 
     ...
     * @return void
     */
    public function __construct($allow =  Hostname ::ALLOW_DNS, $validateMx = false,  Hostname  $hostnameValidator = null)
    {
    ...
    public function isValid($value)
    {
        ...
        if ($this->_validateMx) {
            if ($this->validateMxSupported()) {
                ...
                throw new  ValidateException ('Internal error: MX checking not available on this system');
            }
        }
