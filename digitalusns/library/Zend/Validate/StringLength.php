...
class  StringLength  extends  ValidateAbstract 
{
    ...
    public function setMin($min)
    {
        if (null !== $this->_max && $min > $this->_max) {
            ...
            throw new  ValidateException ("The minimum must be less than or equal to the maximum length, but $min >"
                                            . " $this->_max");
        }
    ...
    public function setMax($max)
    {
        if (null === $max) {
             ...
             */
            require_once 'Zend/Validate/Exception.php';
            throw new  ValidateException ("The maximum must be greater than or equal to the minimum length, but "
                                            . "$max < $this->_min");
        } else {
