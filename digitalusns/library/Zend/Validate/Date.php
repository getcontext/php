 ...
 * @version    $Id: Date.php 9613 2008-06-05 11:49:58Z thomas $
 */
...
class  Date  extends  ValidateAbstract 
{
    ...
    public function setLocale($locale = null)
    {
        if ($locale !== null) {
            ...
            if (! Locale ::isLocale($locale)) {
                ...
                throw new  ValidateException ("The locale '$locale' is no known locale");
            }
        }
        $this->_locale = $locale;
        return $this;
     ...
     * according to  ZendDate , see  ZendDate ::isDate()
     *
     * @param  string $value
     * @return boolean
     */
    public function isValid($value)
    {
        ...
        if (($this->_format !== null) or ($this->_locale !== null)) {
            ...
            if (! ZendDate ::isDate($value, $this->_format, $this->_locale)) {
    ...
    private function _checkFormat($value)
    {
        try {
            ...
            $parsed =  Format ::getDate($value, array(
