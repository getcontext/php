...
use Zend\Acl\Assert\AssertInterface as AclAssertInterface;
use Zend\Acl\Role\RoleInterface as AclRoleInterface;
use Zend\Acl\Role\Registry as Registry;
...
class  Acl 
{
     ...
     */
    public function addRole( AclRoleInterface  $role, $parents = null)
    {
     ...
     * @param   AclResourceInterface |string $parent
     * @throws  AclException 
     * @return  Acl  Provides a fluent interface
     */
    public function add( AclResourceInterface  $resource, $parent = null)
    {
        ...
        if (null !== $parent) {
            try {
                if ($parent instanceof  AclResourceInterface ) {
     ...
     * @throws  Acl _Resource_Registry_Exception
     * @return boolean
     */
     ...
     *
     * @param   AclRoleInterface |string|array     $roles
     * @param   AclResourceInterface |string|array $resources
     * @param  string|array                             $privileges
     * @param   AclAssertInterface                 $assert
     * @uses    Acl ::setRule()
     * @return  Acl  Provides a fluent interface
     */
    public function allow($roles = null, $resources = null, $privileges = null,  AclAssertInterface  $assert = null)
    {
     ...
     * @return  Acl  Provides a fluent interface
     */
    public function deny($roles = null, $resources = null, $privileges = null,  AclAssertInterface  $assert = null)
    {
    ...
    public function setRule($operation, $type, $roles = null, $resources = null, $privileges = null,
                             AclAssertInterface  $assert = null)
    {
     ...
     * @return boolean|null
     */
    protected function _roleDFSAllPrivileges( AclRoleInterface  $role,  AclResourceInterface  $resource = null)
    {
        $dfs = array(
            'visited' => array(),
            'stack'   => array()
     ...
     * @throws  AclException 
     */
    protected function _roleDFSVisitAllPrivileges( AclRoleInterface  $role,  AclResourceInterface  $resource = null,
                                                 &$dfs = null)
    {
        if (null === $dfs) {
            /**
     ...
     * @throws  AclException 
     */
    protected function _roleDFSOnePrivilege( AclRoleInterface  $role,  AclResourceInterface  $resource = null,
                                            $privilege = null)
    {
        if (null === $privilege) {
            /**
     ...
     * @throws  AclException 
     */
    protected function _roleDFSVisitOnePrivilege( AclRoleInterface  $role,  AclResourceInterface  $resource = null,
     ...
     * @return string|null
     */
    protected function _getRuleType( AclResourceInterface  $resource = null,  AclRoleInterface  $role = null,
                                    $privilege = null)
    {
     ...
     * @return array|null
     */
    protected function &_getRules( AclResourceInterface  $resource = null,  AclRoleInterface  $role = null,
                                  $create = false)
    {
