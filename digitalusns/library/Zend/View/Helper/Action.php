...
class  Action  extends  ViewHelperAbstract  
{
    /**
     * @var string
     */
    ...
    public function __construct()
    {
        ...
        if (empty($modules)) {
            ...
            throw new  ViewException ('Action helper depends on valid front controller instance');
        }
        ...
        if (empty($request) || empty($response)) {
            require_once 'Zend/View/Exception.php';
            throw new  ViewException ('Action view helper requires both a registered request and response object in the front controller instance');
        }
