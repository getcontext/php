...
use Zend\View\Helper\Partial\Exception as ViewHelperPartialException;
...
class  Partial  extends  ViewHelperAbstract 
{
    /**
    ...
    public function partial($name = null, $module = null, $model = null)
    {
        ...
        if ((null !== $module) && is_string($module)) {
            $moduleDir =  Front ::getInstance()->getControllerDirectory($module);
            if (null === $moduleDir) {
                require_once 'Zend/View/Helper/Partial/Exception.php';
                throw new  ViewHelperPartialException ('Cannot render partial; module does not exist');
            }
