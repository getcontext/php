...
class  HeadStyle  extends  Standalone 
{
    /**
     * Registry key \for placeholder
     * @var string
     */
    protected $_regKey = '\Zend\View\Helper\HeadStyle';
     ...
     * @param  array $args 
     * @return void
     * @throws  ViewException  When no $content provided or invalid method
     */
    public function __call($method, $args)
    {
        if (preg_match('/^(?P<action>set|(ap|pre)pend|offsetSet)(Style)$/', $method, $matches)) {
            ...
            if (1 > $argc) {
                ...
                throw new  ViewException (sprintf('Method "%s" requires minimally content \for the stylesheet', $method));
            }
    ...
    public function append($value)
    {
        if (!$this->_isValid($value)) {
            require_once 'Zend/View/Exception.php';
            throw new  ViewException ('Invalid value passed to append; please use appendStyle()');
        }
    ...
    public function offsetSet($index, $value)
    {
        if (!$this->_isValid($value)) {
            require_once 'Zend/View/Exception.php';
            throw new  ViewException ('Invalid value passed to offsetSet; please use offsetSetStyle()');
        }
    ...
    public function prepend($value)
    {
        if (!$this->_isValid($value)) {
            require_once 'Zend/View/Exception.php';
            throw new  ViewException ('Invalid value passed to prepend; please use prependStyle()');
        }
    ...
    public function set($value)
    {
        if (!$this->_isValid($value)) {
            require_once 'Zend/View/Exception.php';
            throw new  ViewException ('Invalid value passed to set; please use setStyle()');
        }
     ...
     * @return void
     */
    public function captureStart($type =  ViewHelperPlaceholderContainerAbstract ::APPEND, $attrs = null)
    {
        if ($this->_captureLock) {
            require_once 'Zend/View/Helper/Placeholder/Container/Exception.php';
            throw new  ViewHelperPlaceholderContainerException ('Cannot nest headStyle captures');
        }
