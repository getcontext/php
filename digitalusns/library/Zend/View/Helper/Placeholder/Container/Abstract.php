...
abstract class  ContainerAbstract  extends \ArrayObject
{
    /**
     ...
     * @return void
     * @throws \Zend\View\Helper\Placeholder_Exception if nested captures detected
     */
    public function captureStart($type =  ContainerAbstract ::APPEND, $key = null)
    {
        if ($this->_captureLock) {
            require_once 'Zend/View/Helper/Placeholder/Container/Exception.php';
            throw new  ViewHelperPlaceholderContainerException ('Cannot nest placeholder captures \for the same placeholder');
        }
