...
class  Reflection 
{
     ...
     *
     * Creates a {@link  ServerReflectionClass } object \for the class or
     * object provided.
     *
     ...
     * @throws  ServerReflectionException 
     */
    public static function reflectClass($class, $argv = false, $namespace = '')
    {
        if (is_object($class)) {
            ...
            throw new  ServerReflectionException ('Invalid class or object passed to attachClass()');
        }

        if ($argv && !is_array($argv)) {
            throw new  ServerReflectionException ('Invalid argv argument passed to reflectClass');
        }

        return new  ServerReflectionClass ($reflection, $namespace, $argv);
    }
     ...
     * {@link  ServerReflectionFunction } object.
     *
     ...
     * @return  ServerReflectionFunction 
     * @throws  ServerReflectionException 
     */
    public static function reflectFunction($function, $argv = false, $namespace = '')
    {
        if (!is_string($function) || !function_exists($function)) {
            throw new  ServerReflectionException ('Invalid function "' . $function . '" passed to reflectFunction');
        }
        ...
        return new  ServerReflectionFunction (new ReflectionFunction($function), $namespace, $argv);
    }
}
