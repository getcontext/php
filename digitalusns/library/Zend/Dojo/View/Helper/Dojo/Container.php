...
use Zend\Dojo\View\Helper\Dojo as DojoViewHelperDojo;
use Zend\Dojo\View\ViewInterface as DojoViewInterface;
use Zend\Dojo\View\Exception as DojoViewException;
use Zend\View\ViewInterface as ViewInterface;
use Zend\Dojo as ZendDojo;
...
{ 
     ...
     * @var string
     */
    protected $_cdnBase =  ZendDojo ::CDN_BASE_AOL;

    /**
     * Path segment following version string \of CDN path
     * @var string
     */
    protected $_cdnDojoPath =  ZendDojo ::CDN_DOJO_PATH_AOL;
    ...
    public function requireModule($module)
    {
        if (!preg_match('/^[a-z][a-z0-9._]+$/i', $module)) {
            ...
            throw new  DojoViewException (sprintf('Module name specified, "%s", contains invalid characters', (string) $module));
        }
...
EOJ;
    ...
    public function __toString()
    {
        ...
        if ( DojoViewHelperDojo ::useDeclarative()) {
