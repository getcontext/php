...
use Zend\Dojo\Form\Element\NumberTextBox as NumberTextBox;
...
class  CurrencyTextBox  extends  NumberTextBox 
{
    ...
    public function setSymbol($symbol)
    {
        ...
        if (3 > $length) {
            ...
            throw new  FormElementException ('Invalid symbol provided; please provide ISO 4217 alphabetic currency code');
        }
        if (3 < $length) {
