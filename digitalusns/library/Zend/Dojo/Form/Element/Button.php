...
use Zend\Dojo\Form\Element\Dijit as Dijit;
...
class  Button  extends  Dijit 
{
     ...
     * Constructor
     * 
     * @param  string|array| Config  $spec Element name or configuration
     * @param  string|array| Config  $options Element value or configuration
     * @return void
     */
