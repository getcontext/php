...
use Zend\Form\Decorator\ViewHelper as ViewHelper;
use Zend\Form\Decorator\Exception as FormDecoratorException;




class  DijitElement  extends  ViewHelper 
{
    /**
     * Element attributes
     * @var array
    ...
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new  FormDecoratorException ('DijitElement decorator cannot render without a registered view object');
        }
