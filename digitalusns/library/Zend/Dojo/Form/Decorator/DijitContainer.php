 ...
 * 
 * @uses       \\Zend\Form_Decorator_Abstract
 * @package    \Zend\Dojo
...
abstract class  DijitContainer  extends \\Zend\Form_Decorator_Abstract
{
    /**
     * \View helper
     * @var string
    ...
    public function getHelper()
    {
        if (null === $this->_helper) {
            ...
            throw new  FormDecoratorException ('No view helper specified fo DijitContainer decorator');
        }
        return $this->_helper;
    }
