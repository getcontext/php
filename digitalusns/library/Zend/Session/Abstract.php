...
abstract class  SessionAbstract 
{
     ...
     * but current \Zend\Session has been marked as read-only.
     */
    const _THROW_NOT_WRITABLE_MSG = '\Zend\Session is currently marked as read-only.';


    /**
     * Error message thrown when an action requires reading session data,
     * but current \Zend\Session is not marked as readable.
     */
    const _THROW_NOT_READABLE_MSG = '\Zend\Session is not marked as readable.';
