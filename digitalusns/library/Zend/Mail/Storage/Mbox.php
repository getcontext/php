...
class  Mbox  extends  MailStorageAbstract 
{
    /**
    ...
    public function __construct($params)
    {
        ...
        if (!isset($params->filename) /* ||  Loader ::isReadable($params['filename']) */) {
            /**
             * @see  MailStorageException 
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('no valid filename given in params');
        }
    ...
    protected function _openMboxFile($filename)
    {
        ...
        if (!$this->_fh) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('cannot open mbox file');
        }
        ...
        if (!$this->_isMboxFile($this->_fh, false)) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('file is not a valid mbox format');
        }
    ...
    public function removeMessage($id)
    {
         ...
         */
        require_once 'Zend/Mail/Storage/Exception.php';
        throw new  MailStorageException ('mbox is read-only');
    }
