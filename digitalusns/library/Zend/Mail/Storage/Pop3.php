...
use Zend\Mail\Protocol\Pop3 as MailProtocolPop3;
...
class  Pop3  extends  MailStorageAbstract 
{
    /**
     * protocol handler
     * @var null| MailProtocolPop3 
     */
    protected $_protocol;
    ...
    public function getRawContent($id, $part = null)
    {
        ...
        // TODO: find a way to avoid decoding the headers
         Decode ::splitMessage($content, $null, $body);
        return $body;
    }
    ...
    public function __construct($params)
    {
        ...
        if ($params instanceof  MailProtocolPop3 ) {
        ...
        $this->_protocol = new  MailProtocolPop3 ();
