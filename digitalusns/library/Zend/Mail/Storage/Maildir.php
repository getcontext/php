...
class  Maildir  extends  MailStorageAbstract 
{
	/**
    ...
    protected function _getFileData($id, $field = null)
    {
        if (!isset($this->_files[$id - 1])) {
            ...
            throw new  MailStorageException ('id does not exist');
        }
        ...
        if (!isset($this->_files[$id - 1][$field])) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('field does not exist');
        }
    ...
    public function __construct($params)
    {
        ...
        if (!$this->_isMaildir($params->dirname)) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('invalid maildir given');
        }
    ...
    protected function _openMaildir($dirname)
    {
        ...
        if (!$dh) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('cannot open maildir');
        }
        ...
        if ($dh) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('cannot read recent mails in maildir');
        }
    }
    ...
    public function removeMessage($id)
    {
         ...
         */
        require_once 'Zend/Mail/Storage/Exception.php';
        throw new  MailStorageException ('maildir is (currently) read-only');
    }
