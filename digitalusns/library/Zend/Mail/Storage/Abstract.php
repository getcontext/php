...
abstract class  StorageAbstract  implements \Countable, \ArrayAccess, \SeekableIterator
{
    /**
    ...
    public function __get($var)
    {
        ...
        throw new  MailStorageException ($var . ' not found');
    }
     ...
     */
      ...
      *
      * @param    int $id
      * @return   \Zend\Mail\Message message object
      */
     ...
     public function offsetSet($id, $value)
     {
         ...
         */
        require_once 'Zend/Mail/Storage/Exception.php';
        throw new  MailStorageException ('cannot write mail messages via array access');
     }
      ...
      * \Iterator::current()
      *
      * @return   \Zend\Mail\Message current message
      */
