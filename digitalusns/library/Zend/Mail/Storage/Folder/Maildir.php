...
class  Maildir  extends  MailStorageMaildir  implements  MailStorageFolderInterface 
{
    /**
    ...
    protected function _buildFolderTree()
    {
        ...
        if (!$dh) {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ("can't read folders in maildir");
        }
        $dirs = array();
            ...
            do {
                if (strpos($dir, $parent) === 0) {
                    ...
                    if (strpos($local, $this->_delim) !== false) {
                         ...
                         */
                        require_once 'Zend/Mail/Storage/Exception.php';
                        throw new  MailStorageException ('error while reading maildir');
                    }
    ...
    public function selectFolder($globalName)
    {
        ...
        try {
             ...
             */
            require_once 'Zend/Mail/Storage/Exception.php';
            throw new  MailStorageException ('seems like the maildir has vanished, I\'ve rebuild the ' .
