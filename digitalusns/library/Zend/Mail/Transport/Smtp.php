 ...
 *
 * Loads an instance \of  MailProtocolSmtp  and forwards smtp transactions
 *
 * @category   Zend
 * @package    \Zend\Mail
 * @subpackage Transport
...
use Zend\Mail\Protocol\Smtp as MailProtocolSmtp;
...
class  Smtp  extends  MailTransportAbstract 
{
    /**
    ...
    /**
     * Instance \of  MailProtocolSmtp 
     *
     * @var  MailProtocolSmtp 
     */
    ...
    {
        if ($this->_connection instanceof  MailProtocolSmtp ) {
            try {
     ...
     *
     * @param  MailProtocolAbstract  $client
     *
     * @return void
     */
    public function setConnection( MailProtocolAbstract  $connection)
    {
     ...
     *
     * @return \Zend\Mail_Protocol|null
     */
    ...
    public function _sendMail()
    {
        ...
        if (!($this->_connection instanceof  MailProtocolSmtp )) {
            ...
            if ($this->_auth) {
             ...
             Loader ::loadClass($connectionClass);
        ...
        $this->_connection->data($this->header .  Mime ::LINEEND . $this->body);
    }
