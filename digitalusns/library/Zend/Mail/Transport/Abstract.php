...
abstract class  TransportAbstract  
{
     ...
     * on the mail parts present in the {@link $_mail  Mail  object} present.
     *
     ...
     * @access protected
     * @return void
     * @throws  MailTransportException  if any header lines exceed 998
     * characters
     */
    protected function _prepareHeaders($headers)
    {
        if (!$this->_mail) {
            ...
            throw new  MailTransportException ('Missing  Mail  object in _mail property');
        }
        ...
        if (!$sane) {
             ...
             */
            require_once 'Zend/Mail/Transport/Exception.php';
            throw new  MailException ('At least one mail header line is too long');
        }
    }
     ...
     * multipart/alternative  Part  containing the headers and contents
     * \of each. Otherwise, uses whichever \of the text or HTML parts present.
     *
     * The content part is then prepended to the list \of  Part s \for
     * this message.
     *
     * @return void
     */
    protected function _buildBody()
    {
            ...
            && ($html = $this->_mail->getBodyHtml()))
        {
            ...
            $mp           = new  Part ($body);
            $mp->type     =  Mime ::MULTIPART_ALTERNATIVE;
        ...
        if (!$body) {
             ...
             */
            require_once 'Zend/Mail/Transport/Exception.php';
            throw new  MailTransportException ('No body specified');
        }
        ...
        foreach ($headers as $header) {
            // Headers in  Part  are kept as arrays with two elements, a
            // key and a value
     ...
     * @access public
     * @return void
     * @throws  MailTransportException  if mail is empty
     */
    public function send( Mail  $mail)
    {
        ...
        if ($count < 1) {
             ...
             */
            require_once 'Zend/Mail/Transport/Exception.php';
            throw new  MailTransportException ('Empty mail cannot be sent');
        }

        if ($count > 1) {
            // Multipart message; create new MIME object and boundary
            $mime     = new  Mime ($this->_mail->getMimeBoundary());
