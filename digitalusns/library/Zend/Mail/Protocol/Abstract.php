...
abstract class  ProtocolAbstract 
{
    ...
    {
        $this->_validHost = new  Validate ();
        $this->_validHost->addValidator(new  Hostname ( Validate _Hostname::ALLOW_ALL));
        ...
        if (!$this->_validHost->isValid($host)) {
            ...
            throw new  MailProtocolException (join(', ', $this->_validHost->getMessages()));
        }
    ...
    protected function _connect($remote)
    {
        ...
        if ($this->_socket === false) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ($errorStr);
        }
        ...
        if (($result = stream_set_timeout($this->_socket, self::TIMEOUT_CONNECTION)) === false) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('Could not set stream timeout');
        }
    ...
    protected function _send($request)
    {
        if (!is_resource($this->_socket)) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('No connection has been established to ' . $this->_host);
        }
        ...
        if ($result === false) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('Could not send request to ' . $this->_host);
        }
    ...
    protected function _receive($timeout = null)
    {
        ...
        if (!empty($info['timed_out'])) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ($this->_host . ' has timed out');
        }
        ...
        if ($reponse === false) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('Could not read from ' . $this->_host);
        }
     ...
     * Throws a  MailProtocolException  if an unexpected code is returned.
     *
    ...
    protected function _expect($code, $timeout = null)
    {
        ...
        do {
            ...
            if ($cmd === null || !in_array($cmd, $code)) {
                 ...
                 */
                require_once 'Zend/Mail/Protocol/Exception.php';
                throw new  MailProtocolException ($result);
            }
