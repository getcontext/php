...
/**
 * @see  MailProtocolAbstract 
 */
require_once 'Zend/Mail/Protocol/Abstract.php';


/**
 * Smtp implementation \of  MailProtocolAbstract 
 *
...
use Zend\Mail\Protocol\ProtocolAbstract as MailProtocolAbstract;
use Zend\Mime as Mime;




class  Smtp  extends  MailProtocolAbstract 
{
    /**
        ...
        if (isset($config['ssl'])) {
            switch (strtolower($config['ssl'])) {
                ...
                default:
                    ...
                    throw new  MailProtocolException ($config['ssl'] . ' is unsupported SSL type');
                    break;
            }
        }
    ...
    public function helo($host = '127.0.0.1')
    {
        ...
        if ($this->_sess === true) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('Cannot issue HELO to existing session');
        }
        ...
        if (!$this->_validHost->isValid($host)) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException (join(', ', $this->_validHost->getMessage()));
        }
        ...
        if ($this->_secure == 'tls') {
            ...
            if (!stream_socket_enable_crypto($this->_socket, true, STREAM_CRYPTO_METHOD_TLS_CLIENT)) {
                 ...
                 */
                require_once 'Zend/Mail/Protocol/Exception.php';
                throw new  MailProtocolException ('Unable to connect via TLS');
            }
            $this->_ehlo($host);
        }
    ...
    public function mail($from)
    {
        if ($this->_sess !== true) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('A valid session has not been started');
        }
    ...
    public function rcpt($to)
    {
        if ($this->_mail !== true) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('No sender reverse path has been supplied');
        }
    ...
    public function data($data)
    {
        ...
        if ($this->_rcpt !== true) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('No recipient forward path has been supplied');
        }
    ...
    public function auth()
    {
        if ($this->_auth === true) {
             ...
             */
            require_once 'Zend/Mail/Protocol/Exception.php';
            throw new  MailProtocolException ('Already authenticated \for this session');
        }
    }
