...
use Zend\Locale\Data\Translation as Translation;
...
class  Locale 
{
     ...
     * @throws  LocaleException  When autodetection has been failed
     */
    public function __construct($locale = null)
    {
        if (empty(self::$_auto) === true) {
            ...
            if ((empty($locale) === true) and (empty(self::$_auto) === true) and
                ...
                throw new  LocaleException ('Autodetection \of Locale has been failed!');
            }
        }
     ...
     *
     * @param  string| Locale  $locale Locale to set
     * @throws  LocaleException  When a autolocale was given
     * @throws  LocaleException  When a unknown locale was given
     * @return boolean
     */
    public static function setDefault($locale)
    {
        if (($locale === 'auto') or ($locale === 'root') or
            ...
            require_once 'Zend/Locale/Exception.php';
            throw new  LocaleException ('Only full qualified locales can be used as default!');
        }
        ...
        require_once 'Zend/Locale/Exception.php';
        throw new  LocaleException ("Unknown locale '$locale' can not be set as default!");
    }
    ...
    public function getEnvironment()
    {
        ...
        foreach ($languages as $locale) {
            ...
            if ($language !== 'C') {
                ...
                if (empty( Translation ::$localeTranslation[$splitted[0]]) === false) {
                    if (empty( Translation ::$localeTranslation[$splitted[1]]) === false) {
                        $languagearray[ Translation ::$localeTranslation[$splitted[0]] . '_' .
                         Translation ::$localeTranslation[$splitted[1]]] = 1;
                    }

                    $languagearray[ Translation ::$localeTranslation[$splitted[0]]] = 1;
                }
            }
        }
     ...
     * Sets a new locale
     *
     * @param  string| Locale  $locale (Optional) New locale to set
     * @return void
     */
     ...
     *
     * @param   Locale  $object Locale to check \for equality
     * @return boolean
     */
    ...
    public function getTranslationList($path = null, $locale = null, $value = null)
    {
        ...
        $result =  LocaleData ::getList($locale, $path, $value);
     ...
     *
     * @param  string| Locale  $locale (Optional) Locale \for language translation
     * @return array
     */
     ...
     *
     * @param  string| Locale  $locale (Optional) Locale \for script translation
     * @return array
     */
     ...
     *
     * @param  string| Locale  $locale (Optional) Locale \for country translation
     * @return array
     */
     ...
     *
     * @param  string| Locale  $locale (Optional) Locale \for territory translation
     * @return array
     */
    ...
    public function getTranslation($value = null, $path = null, $locale = null)
    {
        ...
        require_once 'Zend/Locale/Data.php';
        $result =  LocaleData ::getContent($locale, $path, $value);
        if (empty($result) === true) {
            return false;
        }
     ...
     *
     * @param  string| Locale  $locale (Optional) Locale \for language translation (defaults to $this locale)
     * @return array
     */
    public function getQuestion($locale = null)
    {
        ...
        require_once 'Zend/Locale/Data.php';
        $quest             =  LocaleData ::getList($locale, 'question');
     ...
     *
     * @param  string| Locale  $locale Locale to check \for
