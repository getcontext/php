...
use Zend\Loader\PluginLoader\Exception as LoaderPluginLoaderException;
use Zend\Loader as Loader;




class  PluginLoader  implements  LoaderPluginLoaderInterface 
{
    /**
    ...
    public function addPrefixPath($prefix, $path)
    {
        if (!is_string($prefix) || !is_string($path)) {
            ...
            throw new  LoaderPluginLoaderException ('\Zend\Loader\PluginLoader::addPrefixPath() method only takes strings \for prefix and path.');
        }
    ...
    public function removePrefixPath($prefix, $path = null)
    {
        ...
        if (!isset($registry[$prefix])) {
            require_once 'Zend/Loader/PluginLoader/Exception.php';
            throw new  LoaderPluginLoaderException ('Prefix ' . $prefix . ' was not found in the PluginLoader.');
        }
        ...
        if ($path != null) {
            ...
            if ($pos === null) {
                require_once 'Zend/Loader/PluginLoader/Exception.php';
                throw new  LoaderPluginLoaderException ('Prefix ' . $prefix . ' / Path ' . $path . ' was not found in the PluginLoader.');
            }
     ...
     * @throws  Loader _Exception if class not found
     */
    public function load($name)
    {
        ...
        foreach ($registry as $prefix => $paths) {
            ...
            foreach ($paths as $path) {
                ...
                if ( Loader ::isReadable($path . $classFile)) {
        ...
        require_once 'Zend/Loader/PluginLoader/Exception.php';
        throw new  LoaderPluginLoaderException ('Plugin by name ' . $name . ' was not found in the registry.');
    }
}
