...
class  DbTable  implements  AuthAdapterInterface 
{
    /**
     * Database Connection
     *
     ...
     *
     * @param   DbAdapterAbstract  $zendDb
     ...
     * @return void
     */
    public function __construct( DbAdapterAbstract  $zendDb, $tableName = null, $identityColumn = null,
    ...
    /**
     * authenticate() - defined by  AuthAdapterInterface .  This method is called to 
     ...
     *
     * @throws  AuthAdapterException  if answering the authentication query is impossible
     * @return  Result 
     */
    public function authenticate()
    {
        ...
        if ( ($authResult = $this->_authenticateValidateResultset($resultIdentities)) instanceof  Result ) {
            return $authResult;
        }
     ...
     *
     * @throws  AuthAdapterException  - in the event that setup was not done properly
     * @return true
     */
    protected function _authenticateSetup()
    {
        ...
        if (null !== $exception) {
            ...
            throw new  AuthAdapterException ($exception);
        }
    ...
    /**
     * _authenticateCreateSelect() - This method creates a  Select  object that
    ...
    /**
     * _authenticateQuerySelect() - This method accepts a  Select  object and
     * performs a query against the database with that object.
     *
     * @param  Select  $dbSelect
     * @throws  AuthAdapterException  - when a invalid select object is encoutered
     * @return array
     */
    protected function _authenticateQuerySelect( Select  $dbSelect)
    {
        try {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('The supplied parameters to  DbTable  failed to '
