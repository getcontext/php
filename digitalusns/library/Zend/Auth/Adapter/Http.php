...
class  Http  implements  AuthAdapterInterface 
{
    /**
     * \Reference to the HTTP Request object
     *
     * @var  ControllerRequestHttp 
     */
    protected $_request;
     ...
     *
     * @var  AuthAdapterHttpResolverInterface 
     */
    ...
    public function __construct(array $config)
    {
        if (!extension_loaded('hash')) {
            ...
            throw new  AuthAdapterException (__CLASS__  . ' requires the \'hash\' extension');
        }
        ...
        if (empty($config['accept_schemes'])) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('Config key \'accept_schemes\' is required');
        }
        ...
        if (empty($this->_acceptSchemes)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('No supported schemes given in \'accept_schemes\'. Valid values: '
        ...
        if (empty($config['realm']) ||
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('Config key \'realm\' is required, and must contain only printable '
        ...
        if (in_array('digest', $this->_acceptSchemes)) {
            if (empty($config['digest_domains']) ||
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new  AuthAdapterException ('Config key \'digest_domains\' is required, and must contain '
            ...
            if (empty($config['nonce_timeout']) ||
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new  AuthAdapterException ('Config key \'nonce_timeout\' is required, and must be an '
                                                    . 'integer');
            } else {
     ...
     *
     * @param   AuthAdapterHttpResolverInterface  $resolver
     * @return  Http  Provides a fluent interface
     */
    public function setBasicResolver( AuthAdapterHttpResolverInterface  $resolver)
    {
     ...
     *
     * @return  AuthAdapterHttpResolverInterface 
     */
     ...
     * @return  Http  Provides a fluent interface
     */
    public function setDigestResolver( AuthAdapterHttpResolverInterface  $resolver)
    {
     ...
     *
     * @param   ControllerRequestHttp  $request
     * @return  Http  Provides a fluent interface
     */
    public function setRequest( ControllerRequestHttp  $request)
    {
     ...
     *
     * @param   ControllerResponseHttp  $response
     * @return  Http  Provides a fluent interface
     */
    public function setResponse( ControllerResponseHttp  $response)
    {
    ...
    public function authenticate()
    {
        if (empty($this->_request) ||
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('Request and Response objects must be set before calling '
                                                . 'authenticate()');
        }
        ...
        switch ($clientScheme) {
            ...
            default:
                ...
                */
 	            require_once 'Zend/Auth/Adapter/Exception.php';
 	            throw new  AuthAdapterException ('Unsupported authentication scheme');
        }
     ...
     *
     * @return  Result  Always returns a non-identity Auth result
     */
    ...
    protected function _basicAuth($header)
    {
        if (empty($header)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('The value \of the client Authorization header is required');
        }
        if (empty($this->_basicResolver)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('A basicResolver object must be set before doing Basic '
                                                . 'authentication');
        }
        ...
        if (!$auth) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('Unable to base64_decode Authorization header value');
        }
        ...
        if ($password && $password == $creds[1]) {
            ...
            return new  Result (\Zend\Auth\Result::SUCCESS, $identity);
        } else {
            return $this->_challengeClient();
        }
    }
     ...
     * @param  string $header Client's Authorization header
     * @throws  AuthAdapterException 
     * @return  Result  Valid auth result only on successful auth
     */
    protected function _digestAuth($header)
    {
        ...
        if (empty($this->_digestResolver)) {
             ...
             */
            require_once 'Zend/Auth/Adapter/Exception.php';
            throw new  AuthAdapterException ('A digestResolver object must be set before doing Digest authentication');
        }
        ...
        switch ($data['qop']) {
            ...
            default:
                 ...
                 */
                require_once 'Zend/Auth/Adapter/Exception.php';
                throw new  AuthAdapterException ('Client requested an unsupported qop option');
        }
