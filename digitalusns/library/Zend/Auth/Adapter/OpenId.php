...
/**
 * A \Zend\Auth Authentication Adapter allowing the use \of OpenID protocol as an
...
use Zend\OpenId\Consumer as Consumer;
...
class  OpenId  implements  AuthAdapterInterface 
{
    /**
     ...
     * @param  Storage  $storage an optional implementation
     *        \of a storage object
     ...
     *
     * @param  string $id the identity value
     * @return  OpenId  Provides a fluent interface
     */
     ...
     *
     * @throws \Zend\Auth\Adapter\Exception If answering the authentication query is impossible
     * @return  Result 
     */
    public function authenticate() {
        $id = $this->_id;
        if (!empty($id)) {
            $consumer = new  Consumer ($this->_storage);
