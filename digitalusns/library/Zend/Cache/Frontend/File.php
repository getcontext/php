...
class  File  extends  Core 
{
    ...
    public function __construct(array $options = array())
    {
        ...
        if (!isset($this->_specificOptions['master_file'])) {
             Cache ::throwException('master_file option must be set');
        }
        clearstatcache();
        if (!($this->_masterFile_mtime = @filemtime($this->_specificOptions['master_file']))) {
             Cache ::throwException('Unable to read master_file : '.$this->_specificOptions['master_file']);
        }
    }
