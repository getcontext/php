...
/**
 *  Figlet  is a PHP implementation \of FIGlet
 *
 * @category  Zend
 * @package    Figlet 
 * @copyright Copyright (c) 2005-2008 Zend Technologies USA Inc. (http://www.zend.com)
...
use Zend\Text\Figlet\Exception as TextFigletException;
...
class  Figlet 
{
     ...
     * the values \of  Figlet ::JUSTIFICATION_*
     *
     * @var integer
     */
     ...
     *
     * For using font default, this parameter should be null, else one \of
     * the values \of  Figlet ::DIRECTION_*
     *
     * @var integer
     */
     ...
     *  Config .
     *
     * @param array| Config  $options Options \for the output
     */
     ...
     *
     * @param   Config  $config Configuration \for  Figlet 
     * @return  Figlet 
     */
     ...
     *  Figlet ::DIRECTION_LEFT_TO_RIGHT. For writing from right to left,
     * use  Figlet ::DIRECTION_RIGHT_TO_LEFT.
     *
     ...
     * Set the smush mode.
     *
     * Use one \of the constants \of  Figlet ::SM_*, you may combine them.
     *
     ...
     * @throws  TextFigletException     When $text it not properly encoded
     * @return string
     */
    public function render($text, $encoding = 'UTF-8')
    {
        ...
        if ($textLength === false) {
            ...
            throw new  TextFigletException ('$text is not encoded with ' . $encoding);
        }
     ...
     * @throws  TextFigletException  When font file was not found
     * @throws  TextFigletException  When GZIP library is required but not found
     * @throws  TextFigletException  When font file is not readable
     * @return void
     */
    protected function _loadFont($fontFile)
    {
        ...
        if (!file_exists($fontFile)) {
            require_once 'Zend/Text/Figlet/Exception.php';
            throw new  TextFigletException ($fontFile . ': Font file not found');
        }
        ...
        if (substr($fontFile, -3) === '.gz') {
            if (!function_exists('gzcompress')) {
                require_once 'Zend/Text/Figlet/Exception.php';
                throw new  TextFigletException ('GZIP library is required \for '
        ...
        if ($fp === false) {
            require_once 'Zend/Text/Figlet/Exception.php';
            throw new  TextFigletException ($fontFile . ': Could not open file');
        }
        ...
        if ($magic !== self::FONTFILE_MAGIC_NUMBER || $numsRead < 5) {
            require_once 'Zend/Text/Figlet/Exception.php';
            throw new  TextFigletException ($fontFile . ': Not a FIGlet 2 font file');
        }
