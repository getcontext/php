...
use Zend\Cache\Exception as CacheException;
...
abstract class  Cache 
{
     ...
     * @param boolean $customFrontendNaming if true, the frontend argument is used as a complete class name ; if false, the frontend argument is used as the end \of "\Zend\Cache_Frontend_[...]" class name
     * @param boolean $customBackendNaming if true, the backend argument is used as a complete class name ; if false, the backend argument is used as the end \of "\Zend\Cache\Backend_[...]" class name
    ...
    public static function factory($frontend, $backend, $frontendOptions = array(), $backendOptions = array(), $customFrontendNaming = false, $customBackendNaming = false, $autoload = false)
    {
        ...
        if (in_array($frontend, self::$standardFrontends)) {
            ...
            $frontendClass = '\Zend\Cache_' . ($frontend != 'Core' ? 'Frontend_' : '') . $frontend;
            ...
            if (!$customFrontendNaming) {
                ...
                $frontendClass = '\Zend\Cache_Frontend_' . $frontend;
            } else {
     ...
     * does not.
     *
     * \Note : this method comes from \Zend\Loader (see #ZF-2891 \for details)
     *
