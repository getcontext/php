...
class  Entry  extends \ArrayObject
{
     ...
     *
     * @param  array $category see  Entry ::setCategories() \for format
     * @return  Entry 
    ...
    public function addCategory(array $category)
    {
        if (empty($category['term'])) {
            ...
            throw new  FeedBuilderException ("you have to define the name \of the category");
        }
    ...
    public function setEnclosures(array $enclosures)
    {
        foreach ($enclosures as $enclosure) {
            if (empty($enclosure['url'])) {
                 ...
                 */
                require_once 'Zend/Feed/Builder/Exception.php';
                throw new  FeedBuilderException ("you have to supply an url \for your enclosure");
            }
