...
/**
 *  EntryAbstract  represents a single entry in an Atom or RSS
 * feed.
 *
 * @category   Zend
 * @package     Feed 
...
abstract class  EntryAbstract  extends  Element 
{
    /**
    ...
    /**
     *  EntryAbstract  constructor
     *
     * The  EntryAbstract  constructor takes the URI \of the feed the entry
        ...
        if (!($element instanceof DOMElement)) {
            if ($element) {
                ...
                if (!$element) {
                     ...
                     */
                    require_once 'Zend/Feed/Exception.php';
                    throw new  FeedException ('No root <' . $this->_rootElement . '> element found, cannot parse feed.');
                }
            } else {
