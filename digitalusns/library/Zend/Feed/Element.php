...
class  Element  implements \ArrayAccess
{
     ...
     *
     * Get-style access returns a  Element  representing the
    ...
    public function __get($var)
    {
        ...
        if ($length == 1) {
            ...
            return array_map(create_function('$e', 'return new  Element ($e);'), $nodes);
        } else {
    ...
    public function __set($var, $val)
    {
        ...
        if (!$nodes) {
            ...
            throw new  FeedException ('Cannot set the value \of multiple tags simultaneously.');
        } else {
