 ...
 * RSS channel class
 *
 * The  Rss  class is a concrete subclass \of
 *  FeedAbstract  meant \for representing RSS channels. It does not
...
class  Rss  extends  FeedAbstract 
{
    ...
    public function __wakeup()
    {
        ...
        if (!$this->_element) {
            ...
            throw new  FeedException ('No root <channel> element found, cannot parse channel.');
        }
    ...
    /**
     * Override  Feed _Element to include <rss> root node
     *
     * @return string
     */
