...
/**
 * The  FeedAbstract  class is an abstract class representing feeds.
 *
 *  FeedAbstract  implements two core PHP 5 interfaces: \ArrayAccess and
...
abstract class  FeedAbstract  extends  Element  implements \Iterator
{
    /**
     ...
     * Feed constructor
     *
     * The  FeedAbstract  constructor takes the URI \of a feed or a
     ...
     * @param   FeedBuilderInterface  $builder The feed as a builder instance or NULL if retrieved as a string or via HTTP.
     * @return void
     * @throws  FeedException  If loading the feed failed.
     */
    public function __construct($uri = null, $string = null,  FeedBuilderInterface  $builder = null)
    {
        if ($uri !== null) {
     ...
     *
     * @throws  FeedException  if headers have already been sent
     * @return void
     */
