 ...
 * Atom feed class
 *
 * The  Atom  class is a concrete subclass \of the general
 *  FeedAbstract  class, tailored \for representing an Atom
 * feed. It shares all \of the same methods with its abstract
 * parent. The distinction is made in the format \of data that
 *  Atom  expects, and as a further pointer \for users as to
...
class  Atom  extends  FeedAbstract 
{
    ...
    /**
     * Override  FeedAbstract  to set up the $_element and $_entries aliases.
     *
     * @return void
    ...
    public function __wakeup()
    {
        ...
        if (!$element) {
            ...
            if (!$element) {
                ...
                throw new  FeedException ('No root <feed> or <' . $this->_entryElementName
    ...
    /**
     * Override  Element  to allow formated feeds
     *
     * @return string
     */
