...
/**
 * HTTP Proxy-supporting  Client  adapter class, based on the default
 * socket based adapter.
 *
 * Should be used if proxy HTTP access is required. If no proxy is set, will
 * fall back to  Socket  behavior. Just like the
...
use Zend\Http\Client\Adapter\Socket as Socket;
...
class  Proxy  extends  Socket 
{
    ...
    public function write($method, $uri, $http_ver = '1.1', $headers = array(), $body = '')
    {
        ...
        if ($this->connected_to[0] != $host || $this->connected_to[1] != $port) {
            require_once 'Zend/Http/Client/Adapter/Exception.php';
            throw new  HttpClientAdapterException ("Trying to write but we are connected to the wrong proxy server");
	}
        ...
        if (! @fwrite($this->socket, $request)) {
            require_once 'Zend/Http/Client/Adapter/Exception.php';
            throw new  HttpClientAdapterException ("Error writing request to proxy server");
        }
    ...
    protected function connectHandshake($host, $port = 443, $http_ver = '1.1', array &$headers = array())
    {
        ...
        if ( Response ::extractCode($response) != 200) {
                require_once 'Zend/Http/Client/Adapter/Exception.php';
        	throw new  HttpClientAdapterException ("Unable to connect to HTTPS proxy. Server response: " . $response);
        }
        ...
        if (! $success) {
                require_once 'Zend/Http/Client/Adapter/Exception.php';
        	throw new  HttpClientAdapterException ("Unable to connect to" . 
