...
/**
 *  Response  represents an HTTP 1.0 / 1.1 response message. It
...
class  Response 
{
     ...
     *
     * In most cases, you would use  Response ::fromString to parse an HTTP
     * response string and create a new  Response  object.
     *
    ...
    public function __construct($code, $headers, $body = null, $version = '1.1', $message = null)
    {
        ...
        if (self::responseCodeAsText($code) === null) {
            ...
            throw new  HttpException ("{$code} is not a valid HTTP response code");
        }
        ...
        if (! is_array($headers)) {
            require_once 'Zend/Http/Exception.php';
            throw new  HttpException ('No valid headers were passed');
	}
        ...
        if (! preg_match('|^\d\.\d$|', $version)) {
            require_once 'Zend/Http/Exception.php';
            throw new  HttpException ("Invalid HTTP response version: $version");
        }
    ...
    public static function decodeChunkedBody($body)
    {
        ...
        while (trim($body)) {
            if (! preg_match("/^([\da-fA-F]+)[^\r\n]*\r\n/sm", $body, $m)) {
                require_once 'Zend/Http/Exception.php';
                throw new  HttpException ("Error parsing body - doesn't seem to be a chunked message");
            }
    ...
    public static function decodeGzip($body)
    {
        if (! function_exists('gzinflate')) {
            require_once 'Zend/Http/Exception.php';
            throw new  HttpException ('Unable to decode gzipped response ' . 
    ...
    public static function decodeDeflate($body)
    {
        if (! function_exists('gzuncompress')) {
            require_once 'Zend/Http/Exception.php';
            throw new  HttpException ('Unable to decode deflated response ' . 
                'body: perhaps the zlib extension is not loaded?'); 
        }
