 ...
 * - Raise exception  ConsoleGetoptException  in several cases
 ...
 *        the separator with  Getopt ::CONFIG_PARAMETER_SEPARATOR.
 ...
 *        Enable with  Getopt ::CONFIG_CUMULATIVE_PARAMETERS.
 ...
 *        Enable with  Getopt ::CONFIG_CUMULATIVE_FLAGS.
...
use Zend\Console\Getopt\Exception as ConsoleGetoptException;
    ...
    public function setAliases($aliasMap)
    {
        foreach ($aliasMap as $flag => $alias)
        {
            ...
            if (isset($this->_rules[$alias]) || isset($this->_ruleMap[$alias])) {
                 ...
                 * @see  ConsoleGetoptException 
                 */
                throw new  ConsoleGetoptException (
