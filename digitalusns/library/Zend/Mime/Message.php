...
class  Message 
{
    ...
    /**
     * Returns the list \of all  Part s in the message
     *
    ...
    /**
     * Sets the given array \of  Part s as the array \for the message
     *
     * @param array $parts
     */
    ...
    /**
     * Append a new  Part  to the current message
     *
     * @param  Part  $part
     */
     ...
     *
     * @param string $EOL EOL string; defaults to {@link  Mime ::LINEEND}
     * @return string
     */
    ...
    /**
     * Decodes a MIME encoded string and returns a  Message  object with
