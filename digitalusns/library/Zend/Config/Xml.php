...
class  Xml  extends  Config 
{
     ...
     * @throws  ConfigException  When filename is not set
     * @throws  ConfigException  When section $sectionName cannot be found in $filename
     */
     ...
     * @throws  ConfigException  When $section cannot be found
     * @return array
     */
