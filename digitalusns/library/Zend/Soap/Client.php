...
use Zend\Soap\Client\Exception as SoapClientException;
...
class  Client 
{
    ...
    public function __construct($wsdl = null, $options = null)
    {
        if (!extension_loaded('soap')) {
            throw new  SoapClientException ('SOAP extension is not loaded.');
        }
    ...
    public function setOptions(array $options)
    {
        foreach ($options as $key => $value) {
            switch ($key) {
                ...
                default:
                    throw new  SoapClientException ('Unknown SOAP client option');
                    break;
            }
        }
...
//        $options['connection_timeout'] = $this->_connection_timeout;
     ...
     * @return  Client 
     * @throws  SoapClientException  with invalid soap version argument
     */
    public function setSoapVersion($version)
    {
        if (!in_array($version, array(SOAP_1_1, SOAP_1_2))) {
            throw new  SoapClientException ('Invalid soap version specified. Use SOAP_1_1 or SOAP_1_2 constants.');
        }
     ...
     * @return  Client 
     * @throws  SoapClientException  \for any invalid class in the class map
     */
    public function setClassmap(array $classmap)
    {
        foreach ($classmap as $type => $class) {
            if (!class_exists($class)) {
                throw new  SoapClientException ('Invalid class in class map');
            }
        }
     ...
     * @return  Client 
     * @throws  SoapClientException  with invalid encoding argument
     */
    public function setEncoding($encoding)
    {
        if (!is_string($encoding)) {
            throw new  SoapClientException ('Invalid encoding specified');
        }
     ...
     * @param  string $urn
     * @return true
     * @throws  SoapClientException  on invalid URN
     */
    public function validateUrn($urn)
    {
        ...
        throw new  SoapClientException ('Invalid URN');
    }
     ...
     * @param  string $uri
     * @return  Client 
     * @throws  SoapClientException  with invalid uri argument
     */
     ...
     * @return  Client 
     * @throws  SoapClientException  with invalid style argument
     */
    public function setStyle($style)
    {
        if (!in_array($style, array(SOAP_RPC, SOAP_DOCUMENT))) {
            throw new  SoapClientException ('Invalid request style specified. Use SOAP_RPC or SOAP_DOCUMENT constants.');
        }
     ...
     * @return  Client 
     * @throws  SoapClientException  with invalid message encoding method argument
     */
    public function setEncodingMethod($use)
    {
        if (!in_array($use, array(SOAP_ENCODED, SOAP_LITERAL))) {
            throw new  SoapClientException ('Invalid message encoding method. Use SOAP_ENCODED or SOAP_LITERAL constants.');
        }
     ...
     * @return  Client 
     * @throws  SoapClientException  with invalid local certificate path argument
     */
    public function setHttpsCertificate($localCert)
    {
        if (!is_readable($localCert)) {
            throw new  SoapClientException ('Invalid HTTPS client certificate path.');
        }
    ...
    protected function _initSoapClientObject()
    {
        ...
        if ($wsdl == null) {
            if (!isset($options['location'])) {
                throw new  SoapClientException ('\'location\' parameter is required in non-WSDL mode.');
            }
            if (!isset($options['uri'])) {
                throw new  SoapClientException ('\'uri\' parameter is required in non-WSDL mode.');
            }
        } else {
            if (isset($options['use'])) {
                throw new  SoapClientException ('\'use\' parameter only works in non-WSDL mode.');
            }
            if (isset($options['style'])) {
                throw new  SoapClientException ('\'style\' parameter only works in non-WSDL mode.');
            }
        }
        unset($options['wsdl']);
    ...
    public function getFunctions()
    {
        if ($this->getWsdl() == null) {
            throw new  SoapClientException ('\'getFunctions\' method is available only in WSDL mode.');
        }
    ...
    {
        if ($this->getWsdl() == null) {
            throw new  SoapClientException ('\'getTypes\' method is available only in WSDL mode.');
        }
