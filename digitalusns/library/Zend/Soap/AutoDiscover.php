...
class  AutoDiscover  extends  ServerAbstract  implements  ServerInterface  {
    /**
     * @var  Wsdl 
     */
    private $_wsdl = null;
    ...
    {
        $uri =  Uri ::factory('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['SCRIPT_NAME']);

        $wsdl = new  Wsdl ($class, $uri, $this->_extractComplexTypes);
    ...
    public function addFunction($function, $namespace = '')
    {
        ...
        if (!($this->_wsdl instanceof  Wsdl )) {
            ...
            $name = $parts[0];
            $wsdl = new  Wsdl ($name, $uri, $this->_extractComplexTypes);
